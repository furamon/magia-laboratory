...
現にわたしはゲームに触れたことが遠因で3DCGが初心者なりにできるようになったので。物語の交流、それがゲームだとわたしは思います。
...
倍速視聴と違い、ウィンドウにレベルが出る→進行度が常に画面に出ている「ドラクエI」を代表とするファミコン時代から……どんなに遅くとも「ポケットモンスター ルビー・サファイア」を始めとしたGBA・PS2時代から、「みんなで寄り集まってゲームする」前提の設計はされていました。
...
例えばですが「やらなきゃ魅力がわからない」典型の任天堂作品は……ターンベースSLGという時点でニッチ狙いである「ファイアーエムブレム(以下FE)」を含め、十分にライト層にも届いています。

なんでこんな話をしたかと言うと、結局「**高難易度のゲームほど実況で済ませられる可能性は必然的に高くなるしなんならひどいと初心者にそっぽを向かれて沈んでいく**」という身も蓋もない事実です。
これはかの桜井政博氏が指摘しているのが全てで、「ゲーム性を上げすぎると一般性が下がる」。ゲームがマニアックになればなるほどそれに耐えられる層だけが残り、かつその層は得てして発信力が高いのです。ゲーマーから批判されがちな運要素はある意味必要悪なんですね。

何ならこのジレンマでFE以外潰れ、ジャンルとしては死んだSRPG自体がいい例でしょう。
「タクティクスオウガ」などを深く検索すればわかりますが、身も蓋も配慮もない言い方をすれば「**SLGとして完成度が高いほどRPGユーザーがついていけなくなる**」んですよあのジャンル。
FEもなまじ「覚醒」でライト受けしたためにいかにライト層にもゲームを楽しんでもらうか苦慮しているのが近作ほど伝わってきて、Switch2作（「風花雪月」と「エンゲージ」）はベクトルこそ真逆ながらある程度実っていると思います。~~「エンゲージ」は批判はされてるけどほとんどの批判層は「聖戦」以外エアプなので言わせておけばいい~~
...
ゲームオタクの端くれとして、ひいてはゲーム作家ごっこをする身として、迷ったら読み返すつもりでこの記事を書きました。
...
[ゲーム性が上がると一般性が下がるジレンマ　～格ゲー界の敷居を下げる取り組みの歴史～【8000字↑】](https://note.com/u10/n/n72edb33bd75e#5b10667c-a228-4f85-a920-282ef01ff4f4)
