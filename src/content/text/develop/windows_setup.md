...
1. ログアウトして新アカウントで入り、旧ユーザーフォルダの中身を新ユーザーフォルダに持っていく
1. コントロールパネル->ユーザーアカウント->ユーザーアカウント->別のアカウントを管理から旧アカウントをファイルごと削除
1. MSアカウントにログインして再起動
...
#### [**O**bsidian](https://obsidian.md)

試験運用中のノートアプリ。Notionをさらに使いやすくした感じでなかなかいいです。

#### [SyncThing](https://syncthing.net/downloads/)

↑の同期用。ちっちゃいファイルならP2Pで一瞬同期。
...
[https://qiita.com/ka_/items/7d19e8624af26fd5ede2](https://qiita.com/ka_/items/7d19e8624af26fd5ede2)

```powershell
$registryPath = "HKCU:\Control Panel\Accessibility\Keyboard Response"

Set-ItemProperty -Path $registryPath -Name "AutoRepeatDelay" -Value "200" -Type String
...
[MISE](https://mise.jdx.dev/)と[UV](https://github.com/astral-sh/uv)がつよつよ。詳しくは検索を（手抜き）
