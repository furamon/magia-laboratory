...
#### [CubePDF](https://www.cube-soft.jp/cubepdfutility/)
...
Set-ItemProperty -Path $registryPath -Name "AutoRepeatDelay" -Value 170 -Type DWord
Set-ItemProperty -Path $registryPath -Name "AutoRepeatRate" -Value 9 -Type DWord
Set-ItemProperty -Path $registryPath -Name "BounceTime" -Value 0 -Type DWord
Set-ItemProperty -Path $registryPath -Name "DelayBeforeAcceptance" -Value 0 -Type DWord
Set-ItemProperty -Path $registryPath -Name "Flags" -Value 59 -Type DWord
```
