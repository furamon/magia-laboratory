...
の下に古いユーザーフォルダ名のパスが入ってるレジストリキーがあるので探して変えます。\
...
- CPU Ratio Apply ModeをAdaptive、Ratioを51、PerformanceVoltageを1.175
- メモリ周波数に合わせてSoc VoltageとVDDPを調整（5600MhzならSoc1.000VのVDDP0.950V）
- PBOをAll negative 15
- Scaler 10x
- Max Boost Override +100
