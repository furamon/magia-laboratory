...
;(() => {
	...
	const settings = {
		clearEquipWhenMemberIsOut:
			String(pluginParameters.clearEquipWhenMemberIsOut || false) === 'true'
	}
	...
	PluginManager.registerCommand(
		pluginName,
		PLUGIN_COMMAND_NAME.CLEAR_ALL_MEMBER_EQUIP,
		function (args) {
			const equipTypes = JSON.parse(args.equipTypes).map((equipType) => Number(equipType))
	...
	PluginManager.registerCommand(
		pluginName,
		PLUGIN_COMMAND_NAME.CLEAR_ALL_MEMBER_ALL_EQUIP,
		function () {
