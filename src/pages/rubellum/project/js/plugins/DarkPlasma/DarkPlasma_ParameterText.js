...
;(() => {
	...
	const settings = {
		...
		extraParamNameCriticalEvasion: String(
			pluginParameters.extraParamNameCriticalEvasion || '会心回避率'
		),
		extraParamNameMagicEvasion: String(pluginParameters.extraParamNameMagicEvasion || '魔法回避率'),
		extraParamNameMagicReflection: String(
			pluginParameters.extraParamNameMagicReflection || '魔法反射率'
		),
		extraParamNameCounterAttack: String(pluginParameters.extraParamNameCounterAttack || '反撃率'),
		extraParamNameHpRegeneration: String(
			pluginParameters.extraParamNameHpRegeneration || 'HP再生率'
		),
		extraParamNameMpRegeneration: String(
			pluginParameters.extraParamNameMpRegeneration || 'MP再生率'
		),
		extraParamNameTpRegeneration: String(
			pluginParameters.extraParamNameTpRegeneration || 'TP再生率'
		),
		specialParamNameTargetRate: String(pluginParameters.specialParamNameTargetRate || '狙われ率'),
		specialParamNameGuardEffectRate: String(
			pluginParameters.specialParamNameGuardEffectRate || '防御効果率'
		),
		specialParamNameRecoveryEffectRate: String(
			pluginParameters.specialParamNameRecoveryEffectRate || '回復効果率'
		),
		specialParamNamePharmacology: String(
			pluginParameters.specialParamNamePharmacology || '薬の知識'
		),
		specialParamNameMpCostRate: String(pluginParameters.specialParamNameMpCostRate || 'MP消費率'),
		specialParamNameTpChargeRate: String(
			pluginParameters.specialParamNameTpChargeRate || 'TPチャージ率'
		),
		specialParamNamePhysicalDamageRate: String(
			pluginParameters.specialParamNamePhysicalDamageRate || '物理ダメージ率'
		),
		specialParamNameMagicDamageRate: String(
			pluginParameters.specialParamNameMagicDamageRate || '魔法ダメージ率'
		),
		specialParamNameFloorDamageRate: String(
			pluginParameters.specialParamNameFloorDamageRate || '床ダメージ率'
		),
		specialParamNameExperienceRate: String(
			pluginParameters.specialParamNameExperienceRate || '経験獲得率'
		)
	}
