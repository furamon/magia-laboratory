...
;(() => {
	...
	var CharacterCollisionExPluginName = document.currentScript
		? decodeURIComponent(document.currentScript.src.match(/^.*\/(.+)\.js$/)[1])
		: 'CharacterCollisionEx'
	var CharacterCollisionExPluginParams = PluginParamsParser.parse(
		PluginManager.parameters(CharacterCollisionExPluginName)
	)
	PluginManager.registerCommand(
		CharacterCollisionExPluginName,
		'SetThroughTerrain',
		function (args) {
	...
	if (typeof DotMoveSystem !== 'undefined') {
		...
		CharacterCollisionChecker_Mixin._checkPassMass =
			DotMoveSystem.CharacterCollisionChecker.prototype.checkPassMass
		...
		Game_Event_DotMoveMixin._checkCollisionTargetPlayer =
			Game_Event.prototype.checkCollisionTargetPlayer
		Game_Event_DotMoveMixin._checkCollisionTargetFollower =
			Game_Event.prototype.checkCollisionTargetFollower
		Game_Event_DotMoveMixin._checkCollisionTargetEvent =
	...
	if (typeof DotMoveSystem === 'undefined') {
		...
		Game_Event_NotDotMoveMixin._isCollidedWithPlayerCharacters =
