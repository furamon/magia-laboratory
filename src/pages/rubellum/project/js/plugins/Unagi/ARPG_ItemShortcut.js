...
;(() => {
	...
	var Window_RegistShortcutOrUse = class extends Window_Command {
		...
		makeCommandList() {
			...
			this.addCommand(
				ARPG_ItemShortcutPluginParams.Text.RegisterShortcut,
				'registShortcut',
				this._useRegisterShortcutEnabled
			)
		}
	...
	var ShortcutRegisterSceneModule = class extends Scene_ItemBase {
		...
		createRegistShortcutOrUseWindow() {
			...
			this._registShortcutOrUseWindow.setHandler(
				'cancel',
				this.onRegistShortcutOrUseCancel.bind(this)
			)
	...
	var ARPG_ItemShortcutPluginName = document.currentScript
		? decodeURIComponent(document.currentScript.src.match(/^.*\/(.+)\.js$/)[1])
		: 'ARPG_ItemShortcut'
	var ARPG_ItemShortcutPluginParams = import_PluginParamsParser.PluginParamsParser.parse(
		PluginManager.parameters(ARPG_ItemShortcutPluginName)
	)
	if (ARPG_ItemShortcutPluginParams.KeySetting.UseShortcutItem != null) {
		import_ARPG_Utils5.ARPG_Utils.registerKey(
			'UseShortcutItem',
			ARPG_ItemShortcutPluginParams.KeySetting.UseShortcutItem
		)
	}
	...
	PluginManager.registerCommand(
		ARPG_ItemShortcutPluginName,
		'ChangeShortcutEnableOrDisable',
		function (args) {
			const params = import_PluginParamsParser.PluginParamsParser.parse(args)
