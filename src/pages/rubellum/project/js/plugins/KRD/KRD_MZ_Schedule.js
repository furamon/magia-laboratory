...
;(() => {
	...
	Scene_Schedule = class extends Scene_Calendar {
		...
		drawCircle(date, pidStart, pictureName) {
			const diffX = CHANGE_WIDTH_HEIGHT
				? $dataSystem.advanced.screenHeight - $dataSystem.advanced.uiAreaHeight
				: $dataSystem.advanced.screenWidth - $dataSystem.advanced.uiAreaWidth
			const diffY = CHANGE_WIDTH_HEIGHT
				? $dataSystem.advanced.screenWidth - $dataSystem.advanced.uiAreaWidth
				: $dataSystem.advanced.screenHeight - $dataSystem.advanced.uiAreaHeight
	...
	const KRD_Game_Interpreter_setupReservedCommonEvent =
