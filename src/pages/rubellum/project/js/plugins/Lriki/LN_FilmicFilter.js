...
;(() => {
	...
	var n = {
			376: (e, t, n) => {
				...
				var i,
					...
					p = {
						...
						compose: function () {
							...
							return function () {
								for (var e = r.call(arguments), t = n.length - 1; 0 <= t; t--)
									e = [n[t].apply(this, e)]
								return e[0]
							}
						},
						each: function (e, t, n) {
							if (e)
								if (a && e.forEach && e.forEach === a) e.forEach(t, n)
									...
									for (var o = void 0, o = 0, i = e.length; o < i; o++)
				...
				var l,
						...
						},
						{
							...
							conversions: {
								...
								RGB_OBJ: {
									read: function (e) {
										return (
											!!(p.isNumber(e.r) && p.isNumber(e.g) && p.isNumber(e.b)) && {
												space: 'RGB',
												r: e.r,
												g: e.g,
												b: e.b
								...
								HSV_OBJ: {
									read: function (e) {
										return (
											!!(p.isNumber(e.h) && p.isNumber(e.s) && p.isNumber(e.v)) && {
												space: 'HSV',
												h: e.h,
												s: e.s,
												v: e.v
									...
									return (
										p.each(e.conversions, function (e, t) {
											if (((d = e.read(n)), !1 === c && !1 !== d))
												return ((c = d).conversionName = t), (d.conversion = e), p.BREAK
										}),
										p.BREAK
									)
							}),
					...
					_ = {
						...
						rgb_to_hsv: function (e, t, n) {
							...
							return 0 === i
								? { h: NaN, s: 0, v: 0 }
								: ((o = e === i ? (t - n) / r : t === i ? 2 + (n - e) / r : 4 + (e - t) / r),
									(o /= 6) < 0 && (o += 1),
									{ h: 360 * o, s: r / i, v: i / 255 })
						},
				...
				var n = function (e, t) {
					...
					x =
						...
						w)
				function w() {
					if ((f(this, w), (this.__state = h.apply(this, arguments)), !1 === this.__state))
				...
				;(x.recalculateRGB = function (e, t, n) {
					if ('HEX' === e.__state.space) e.__state[t] = _.component_from_hex(e.__state.hex, n)
						...
						p.extend(e.__state, _.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v))
					}
				}),
						...
						fakeEvent: function (e, t, n, o) {
							...
							switch (n) {
								...
								case 'KeyboardEvents':
									...
									break
								default:
									r.initEvent(t, i.bubbles || !1, i.cancelable || !0)
							}
							p.defaults(r, o), e.dispatchEvent(r)
						},
				...
				function B(e, t) {
					f(this, B)
					var t = y(this, (B.__proto__ || Object.getPrototypeOf(B)).call(this, e, t)),
						n = t
					return (
						(t.__prev = t.getValue()),
				...
				function L(e, t, n) {
					f(this, L)
					var o,
						t = y(this, (L.__proto__ || Object.getPrototypeOf(L)).call(this, e, t)),
						n = n,
						i = t
					return (
						...
						p.each(n, function (e, t) {
							...
							;(n.innerHTML = t), n.setAttribute('value', e), i.__select.appendChild(n)
						}),
						t.updateDisplay(),
					...
					g(M, [
						{
							...
							value: function () {
								return (
									k.isActive(this.__input) || (this.__input.value = this.getValue()),
									v(
				...
				function M(e, t) {
					f(this, M)
					var t = y(this, (M.__proto__ || Object.getPrototypeOf(M)).call(this, e, t)),
						n = t
					function o() {
				...
				function N(e, t, n) {
					f(this, N)
					;(t = y(this, (N.__proto__ || Object.getPrototypeOf(N)).call(this, e, t))), (n = n || {})
					return (
						(t.__min = n.min),
						(t.__max = n.max),
						(t.__step = n.step),
						p.isUndefined(t.__step)
							? 0 === t.initialValue
								? (t.__impliedStep = 1)
								: (t.__impliedStep =
										Math.pow(10, Math.floor(Math.log(Math.abs(t.initialValue)) / Math.LN10)) / 10)
							: (t.__impliedStep = t.__step),
						(t.__precision = I(t.__impliedStep)),
						t
					)
				}
				var j =
				...
				function H(e, t, n) {
					f(this, H)
					n = y(this, (H.__proto__ || Object.getPrototypeOf(H)).call(this, e, t, n))
					...
					function a(e) {
						var t = i - e.clientY
						o.setValue(o.getValue() + t * o.__impliedStep), (i = e.clientY)
					}
					function s() {
						k.unbind(window, 'mousemove', a), k.unbind(window, 'mouseup', s), r()
					}
					return (
						...
						k.bind(n.__input, 'mousedown', function (e) {
							k.bind(window, 'mousemove', a), k.bind(window, 'mouseup', s), (i = e.clientY)
						}),
						k.bind(n.__input, 'keydown', function (e) {
							13 === e.keyCode &&
								((o.__truncationSuspended = !0), this.blur(), (o.__truncationSuspended = !1), r())
						}),
						n.updateDisplay(),
				...
				function z(e, t, n, o, i) {
					...
					function a(e) {
						...
						return r.setValue(G(e.clientX, t.left, t.right, r.__min, r.__max)), !1
					}
					function s() {
					...
					function l(e) {
						var t = e.touches[0].clientX,
							e = r.__background.getBoundingClientRect()
						r.setValue(G(t, e.left, e.right, r.__min, r.__max))
					}
					function u() {
					...
					return (
						(i.__background = document.createElement('div')),
						(i.__foreground = document.createElement('div')),
						k.bind(i.__background, 'mousedown', function (e) {
							document.activeElement.blur(),
								k.bind(window, 'mousemove', a),
								k.bind(window, 'mouseup', s),
								a(e)
						}),
						k.bind(i.__background, 'touchstart', function (e) {
							1 === e.touches.length &&
								(k.bind(window, 'touchmove', l), k.bind(window, 'touchend', u), l(e))
						}),
						k.addClass(i.__background, 'slider'),
						k.addClass(i.__foreground, 'slider-fg'),
						i.updateDisplay(),
						i.__background.appendChild(i.__foreground),
						i.domElement.appendChild(i.__background),
						i
					)
				}
				var U =
				...
				function X(e, t, n) {
					f(this, X)
					var t = y(this, (X.__proto__ || Object.getPrototypeOf(X)).call(this, e, t)),
						o = t
					return (
				...
				function K(e, t) {
					f(this, K)
					var n = y(this, (K.__proto__ || Object.getPrototypeOf(K)).call(this, e, t))
					...
					function c(e) {
						...
						var t = o.__hue_field.getBoundingClientRect(),
							t = 1 - (((e.touches && e.touches[0]) || e).clientY - t.top) / (t.bottom - t.top)
						return (
							1 < t ? (t = 1) : t < 0 && (t = 0),
							(o.__color.h = 360 * t),
							o.setValue(o.__color.toOriginal()),
					...
					return (
						...
						p.extend(e.style, { width: '100%', height: '100%', background: 'none' }),
						...
						k.bind(n.__saturation_field, 'mousedown', i),
						k.bind(n.__saturation_field, 'touchstart', i),
						k.bind(n.__field_knob, 'mousedown', i),
						k.bind(n.__field_knob, 'touchstart', i),
				...
				function J(t, n, o, i) {
					;(t.style.background = ''),
						p.each(Y, function (e) {
							t.style.cssText +=
								'background: ' + e + 'linear-gradient(' + n + ', ' + o + ' 0%, ' + i + ' 100%); '
						})
				}
				var n = function (e, t) {
						var n = t || document,
							...
							},
							{
								...
								value: function () {
									;(this.domElement.style.left =
										window.innerWidth / 2 - k.getWidth(this.domElement) / 2 + 'px'),
										(this.domElement.style.top =
											window.innerHeight / 2 - k.getHeight(this.domElement) / 2 + 'px')
								}
							}
						]),
						Z)
				...
				var ee = 'Default',
					...
					se = function t(e) {
						...
						;(this.domElement = document.createElement('div')),
							...
							(this.__listening = []),
							(o = p.defaults(o, { closeOnTop: !1, autoPlace: !0, width: t.DEFAULT_WIDTH })),
							(o = p.defaults(o, { resizable: o.autoPlace, hideable: o.autoPlace })),
						...
						function c(e) {
							return (
								e.preventDefault(), (r.width += a - e.clientX), r.onResize(), (a = e.clientX), !1
							)
						}
						function h() {
							k.removeClass(r.__closeButton, se.CLASS_DRAG),
								k.unbind(window, 'mousemove', c),
						...
						function _(e) {
							return (
								e.preventDefault(),
								(a = e.clientX),
								k.addClass(r.__closeButton, se.CLASS_DRAG),
								k.bind(window, 'mousemove', c),
						...
						Object.defineProperties(this, {
							...
							useLocalStorage: {
								...
								set: function (e) {
									te &&
										((l = e) ? k.bind(window, 'unload', u) : k.unbind(window, 'unload', u),
							...
							p.isUndefined(o.parent)
								? ((this.closed = o.closed || !1),
									...
									te &&
										l &&
										((n.useLocalStorage = !0),
										(i = localStorage.getItem(_e(0, 'gui'))) && (o.load = JSON.parse(i))),
							...
							o.autoPlace &&
								(p.isUndefined(o.parent) &&
									(oe &&
										...
										k.addClass(ie, 'dg'),
										k.addClass(ie, t.CLASS_AUTO_PLACE_CONTAINER),
										document.body.appendChild(ie),
										(oe = !1)),
									ie.appendChild(this.domElement),
							...
							o.resizable &&
								...
								p.extend(r.__resize_handle.style, {
									width: '6px',
									marginLeft: '-3px',
									height: '200px',
									cursor: 'ew-resize',
								...
								k.bind(r.__resize_handle, 'mousedown', _),
								k.bind(r.__closeButton, 'mousedown', _),
								r.domElement.insertBefore(r.__resize_handle, r.domElement.firstElementChild)),
							(u = function () {
								te &&
									'true' === localStorage.getItem(_e(0, 'isLocal')) &&
									localStorage.setItem(_e(0, 'gui'), JSON.stringify(n.getSaveObject()))
							}),
				...
				function ce(e, t) {
					...
					if (-1 !== o) {
						...
						if (
							(void 0 === i && (n.__rememberedObjectIndecesToControllers[o] = i = {}),
							(i[t.property] = t),
							n.load && n.load.remembered)
						) {
							;(i = n.load.remembered), (n = void 0)
							if (i[e.preset]) n = i[e.preset]
							else {
								if (!i[ee]) return
								n = i[ee]
							}
				...
				function he(e, t, n, o) {
					...
					var i = void 0
					;(i = o.color ? new W(t, n) : ((r = [t, n].concat(o.factoryArgs)), $.apply(e, r))),
						o.before instanceof F && (o.before = o.before.__li),
						ce(e, i),
						k.addClass(i.domElement, 'c')
					n = document.createElement('span')
					k.addClass(n, 'property-name'), (n.innerHTML = i.property)
					var r = document.createElement('div')
					r.appendChild(n), r.appendChild(i.domElement)
					var a,
						s,
						l,
						u,
					...
					return (
						...
						i instanceof W ? k.addClass(o, 'color') : k.addClass(o, m(i.getValue())),
						(a = e),
						(s = o),
						((l = i).__li = s),
						(l.__gui = a),
						p.extend(l, {
							options: function (e) {
								if (1 < arguments.length) {
									...
									return (
										l.remove(),
										he(a, l.object, l.property, { before: t, factoryArgs: [p.toArray(arguments)] })
									)
								}
								if (p.isArray(e) || p.isObject(e)) {
									t = l.__li.nextElementSibling
									return l.remove(), he(a, l.object, l.property, { before: t, factoryArgs: [e] })
								}
							},
							name: function (e) {
								return (l.__li.firstElementChild.firstElementChild.innerHTML = e), l
							},
							listen: function () {
						...
						l instanceof V
							? ((u = new j(l.object, l.property, { min: l.__min, max: l.__max, step: l.__step })),
								p.each(
								...
								l.domElement.insertBefore(u.domElement, l.domElement.firstElementChild))
							: l instanceof j
								? ((o = function (e) {
										if (p.isNumber(l.__min) && p.isNumber(l.__max)) {
											var t = l.__li.firstElementChild.firstElementChild.innerHTML,
						...
						(l.setValue = p.compose(function (e) {
							return a.getRoot().__preset_select && l.isModified() && de(a.getRoot(), !0), e
						}, l.setValue)),
				...
				function ge(i, r) {
					var a = {}
					return (
						p.each(i.__rememberedObjects, function (e, t) {
							var n = {},
				...
				;(se.toggleHide = function () {
					;(re = !re),
						p.each(ae, function (e) {
							e.domElement.style.display = re ? 'none' : ''
						})
				}),
					...
					p.extend(se.prototype, {
						...
						destroy: function () {
							...
							this.autoPlace && ie.removeChild(this.domElement)
							var t = this
							...
							p.each(Array.prototype.slice.call(arguments), function (e) {
								0 === t.__rememberedObjects.length &&
									(function (n) {
										...
										;(o.innerHTML = 'Save'), k.addClass(o, 'button'), k.addClass(o, 'save')
						...
						saveAs: function (e) {
							this.load.remembered ||
								((this.load.remembered = {}), (this.load.remembered[ee] = ge(this, !0))),
			...
			455: (e, t, n) => {
				Object.defineProperty(t, '__esModule', { value: !0 }), (t.FilmicFilterControl = void 0)
				const o = n(297)
				t.FilmicFilterControl = class {
					...
					static startFlush(e, t, n) {
						this.copyParams(t, e.params), this.start(e, this.defaultParams(), n)
					}
					...
					static update(e) {
						if (0 < e.paramsDuration) {
							...
							;(o.luminosityThreshold = this.mix(o.luminosityThreshold, n.luminosityThreshold, t)),
								(o.luminositySmoothWidth = this.mix(
									o.luminosityThreshold,
									n.luminosityThreshold,
									t
								)),
								(o.bloomStrength = this.mix(o.luminosityThreshold, n.luminosityThreshold, t)),
								(o.bloomRadius = this.mix(o.luminosityThreshold, n.luminosityThreshold, t)),
								(o.linearWhite = this.mix(o.linearWhite, n.linearWhite, t)),
								(o.shoulderStrength = this.mix(o.shoulderStrength, n.shoulderStrength, t)),
								(o.linearStrength = this.mix(o.linearStrength, n.linearStrength, t)),
								...
								(o.toeDenominator = this.mix(o.toeDenominator, n.toeDenominator, t)),
								...
								(o.vignetteAmount = this.mix(o.vignetteAmount, n.vignetteAmount, t)),
			...
			297: (e, t, n) => {
				Object.defineProperty(t, '__esModule', { value: !0 }), (t.FilterFileManager = void 0)
				const o = n(455)
				t.FilterFileManager = class {
					static loadIndex() {
						;(this._fileCount = -1),
							...
							this.loadDataFile('data/filters/index.json', (e) => {
								this.fileIndex = e
								for (let t = (this._fileCount = 0); t < this.fileIndex.length; t++) {
									var n = this.fileIndex[t]
									n &&
										(this._fileCount++,
										this.loadDataFile('data/filters/' + n, (e) => {
											;(this._dataList[t] = o.FilmicFilterControl.resolveUndefiedParams(e)),
					...
					static getData(e) {
						...
						throw new Error(`ID:${e} の FilmicFilter 設定ファイルが見つかりませんでした。`)
					}
					...
					static onXhrLoad(e, t, n, o) {
						e.status < 400 ? o(JSON.parse(e.responseText)) : DataManager.onXhrError(t, t, n)
					}
						...
						if (this.isNode()) {
							...
							s.mkdir('data/filters', (e) => {
								s.readdir('data/filters', function (e, t) {
									const n = []
									if (!e)
										for (const r of t.filter(function (e) {
											return /.*\.json$/.test(e)
										}))
											if ('index.json' != r) {
												var o = r.split('-')
												if (o.length < 2)
													throw new Error(`${r}: ファイル名にIDが含まれていません。`)
												var i = l.basename(r)
												n[Number(o[0])] = i
											}
									s.writeFileSync('data/filters/index.json', JsonEx.stringify(n)), a()
								})
							})
						} else a()
					}
			...
			987: function (e, t, n) {
				...
				Object.defineProperty(t, '__esModule', { value: !0 }), (t.FilterGUI = void 0)
				const l = o(n(376)),
					u = n(455)
				class d {
					static isPlaytest() {
					...
					static init() {
						if (
							(this._gui && (this._gui.destroy(), (this._gui = void 0), (this._controlers = [])),
							(this._hiddedn = !0),
							(this._controlers = []),
						...
						var t = {
							save: () => {
								...
								;(e.href =
									...
									encodeURIComponent(JsonEx.stringify($gameScreen._lnFilmicFilter.params))),
									...
									(e.onchange = function (e) {
										...
										t.readAsText(e.target.files[0]),
											(t.onload = () => {
												...
												'string' == typeof e &&
													((e = JsonEx.parse(e)),
													u.FilmicFilterControl.copyParams(e, $gameScreen._lnFilmicFilter.params),
													d.refresh())
											})
									}),
									e.click()
						...
						u.FilmicFilterControl.copyParams($gameScreen._lnFilmicFilter.params, n),
						...
						const i = this._gui.addFolder('Tonemap')
						this._controlers.push(i.add(t, 'linearWhite', 0, 10)),
							this._controlers.push(i.add(t, 'shoulderStrength', 0, 10)),
							this._controlers.push(i.add(t, 'linearStrength', 0, 10)),
							this._controlers.push(i.add(t, 'linearAngle', 0, 2)),
							this._controlers.push(i.add(t, 'toeStrength', 0, 1)),
							this._controlers.push(i.add(t, 'toeNumerator', 0, 1)),
							this._controlers.push(i.add(t, 'toeDenominator', 0, 2)),
							this._controlers.push(i.add(t, 'exposure', 0, 2))
						const r = this._gui.addFolder('ColorTone')
						this._controlers.push(r.add(t, 'toneColorR', -1, 1)),
							this._controlers.push(r.add(t, 'toneColorG', -1, 1)),
							this._controlers.push(r.add(t, 'toneColorB', -1, 1)),
							this._controlers.push(r.add(t, 'toneGray', 0, 1))
						...
						this._controlers.push(s.add(t, 'tiltScale', 0, 5)),
							...
							u.FilmicFilterControl.copyParams(n, $gameScreen._lnFilmicFilter.params),
							this.refresh()
					}
					static toggle() {
						var e
			...
			650: function (e, t, n) {
				...
				Object.defineProperty(t, '__esModule', { value: !0 }), (t.LuminosityHighPassFilter = void 0)
				const i = o(n(870))
				class r extends PIXI.Filter {
					constructor() {
						super(void 0, i.default)
					}
					prepare(e, t) {
						;(this.uniforms._LuminosityThreshold = e), (this.uniforms._SmoothWidth = t)
					}
				}
				t.LuminosityHighPassFilter = r
			},
			656: function (e, t, n) {
				var o =
					(this && this.__importDefault) ||
				...
				Object.defineProperty(t, '__esModule', { value: !0 }), (t.FilmicFilter = void 0)
				const i = o(n(445)),
					r = n(650),
					a = n(935)
				...
				class d extends PIXI.Filter {
					constructor(e, t, n, o) {
						super(),
							...
							(this._luminosityHighPassFilter = new r.LuminosityHighPassFilter()),
							(this._seperableBlurPassHList = []),
							(this._seperableBlurPassVList = [])
						for (let e = 0; e < 5; e++)
							this._seperableBlurPassHList.push(new a.SeperableBlurPass(u[e], u[e], !0)),
								this._seperableBlurPassVList.push(new a.SeperableBlurPass(u[e], u[e], !1))
					}
					apply(o, i, e, r, t) {
						...
						if (n && s) {
							var l = o.getFilterTexture(i)
							{
								let t = 0.5
								for (let e = 0; e < 5; e++)
									this._seperableBlurPassHList[e].prepare(o, i, t),
										this._seperableBlurPassVList[e].prepare(o, i, t),
										(t *= 0.5)
								this._luminosityHighPassFilter.prepare(
									a.luminosityThreshold,
									a.luminositySmoothWidth
								),
									this._luminosityHighPassFilter.apply(o, i, l, r)
								let n = l
								for (let e = 0; e < 5; e++) {
									var u = this._seperableBlurPassHList[e].renderTexture(),
										d = this._seperableBlurPassVList[e].renderTexture()
									this._seperableBlurPassHList[e].apply(o, n, u, r),
										this._seperableBlurPassVList[e].apply(o, u, d, r),
										(n = d)
								}
								this.prepareBloomCompositeParams(a.bloomStrength, a.bloomRadius, [
							...
							var c = o.getFilterTexture(i),
								h = o.getFilterTexture(i)
							this._copyPass.apply(o, i, h, !0),
								this.blurXFilter.apply(o, h, c, r),
								this.blurYFilter.apply(o, c, h, r)
							...
							;(this._blendPass.uniforms.inputSampler = i),
							...
							;(this._blendPass.uniforms.paramF_White =
								...
								this._blendPass.apply(o, h, e, r),
								o.returnFilterTexture(c),
								o.returnFilterTexture(h)
							for (let e = 0; e < 5; e++)
								this._seperableBlurPassHList[e].retain(o), this._seperableBlurPassVList[e].retain(o)
					...
					prepareBloomCompositeParams(e, t, n) {
						;(this._blendPass.uniforms._BloomStrength = e),
							...
							(this._blendPass.uniforms._BloomTintColorsAndFactors1 = [1, 1, 1, 1]),
							(this._blendPass.uniforms._BloomTintColorsAndFactors2 = [1, 1, 1, 0.8]),
							(this._blendPass.uniforms._BloomTintColorsAndFactors3 = [1, 1, 1, 0.6]),
							(this._blendPass.uniforms._BloomTintColorsAndFactors4 = [1, 1, 1, 0.4]),
							(this._blendPass.uniforms._BloomTintColorsAndFactors5 = [1, 1, 1, 0.2])
					}
					updatePadding() {
						this._repeatEdgePixels
							? (this.padding = 0)
							: (this.padding =
									2 * Math.max(Math.abs(this.blurXFilter.blur), Math.abs(this.blurYFilter.blur)))
					}
				}
				t.FilmicFilter = d
			},
			935: function (e, t, n) {
				...
				Object.defineProperty(t, '__esModule', { value: !0 }), (t.SeperableBlurPass = void 0)
				const i = o(n(268)),
					r = o(n(357))
				class a extends PIXI.Filter {
					constructor(e, t, n) {
						var o = n ? 1 : 0,
							n = n ? 0 : 1
						super(i.default, r.default, { KERNEL_RADIUS: e, SIGMA: t, _Direction: [o, n] }),
					...
					prepare(e, t, n) {
						var o = t.width * n,
							i = t.height * n
						;(this.requiredWidth === o && this.requiredHeight === i) ||
							((this.requiredWidth = t.width * n),
							(this.requiredHeight = t.height * n),
							this._renderTarget && this._renderTarget.destroy(),
							(e = new PIXI.BaseRenderTexture(
								Object.assign(
									{ width: this.requiredWidth, height: this.requiredHeight, resolution: 1 },
									e.texturePool.textureOptions
								)
							)),
							(this._renderTarget = new PIXI.RenderTexture(e))),
			...
			246: (e, t, n) => {
				...
				const o = n(297),
					i = n(987),
					r = DataManager.createGameObjects
				DataManager.createGameObjects = function () {
					r.call(this), i.FilterGUI.isPlaytest() && i.FilterGUI.init()
				}
			...
			174: (e, t, n) => {
				...
				const o = n(455),
					i = n(297)
				var r = Game_Map.prototype.setup
				Game_Map.prototype.setup = function (e) {
					var t
					r.call(this, e),
						i.FilterFileManager.setUserDefaultParams(void 0),
						...
						$dataMap.meta &&
							...
							(t = void 0 === e ? 0 : Number(e)) <= -1
								...
								: void 0 !== t &&
									(i.FilterFileManager.setUserDefaultParams(i.FilterFileManager.getData(t)),
									o.FilmicFilterControl.start(
										$gameScreen._lnFilmicFilter,
										i.FilterFileManager.defaultParams(),
										0
									)))
				}
			},
			974: (e, t, n) => {
				...
				const r = Game_Screen.prototype.update
				Game_Screen.prototype.update = function () {
					r.call(this), o.FilmicFilterControl.update(this._lnFilmicFilter)
				}
			},
			957: (e, t, n) => {
				Object.defineProperty(t, '__esModule', { value: !0 })
				...
				Input._onKeyDown = function (e) {
					o.FilterGUI.isPlaytest() && e.key == i.paramEditorKey
						? o.FilterGUI.toggle()
						: r.call(this, e)
				}
			},
			994: (e, t, n) => {
				...
				const o = n(455),
					i = n(297)
				n = n(749)
				PluginManager.registerCommand(n.pluginName, 'SetFilmicFilter', function (e) {
					var t = e.filterId,
						n = e.duration,
						e = e.wait
					Number(t) <= -1
						? ($gameScreen._lnFilmicFilter.enabled = !1)
						: ((t = i.FilterFileManager.getData(t)),
			...
			749: (e, t) => {
				var n, o
				Object.defineProperty(t, '__esModule', { value: !0 }),
					(t.paramEditorKey = t.paramAnimationFlushHookValue = t.pluginName = void 0),
				...
				Sprite_Animation.prototype.processFlashTimings = function () {
					for (const n of this._animation.flashTimings) {
						...
						n.frame === this._frameIndex &&
							((e = n.color.clone())[3] == r.paramAnimationFlushHookValue
								? ((t = i.FilterFileManager.getData(e[0])),
									o.FilmicFilterControl.startFlush($gameScreen._lnFilmicFilter, t, n.duration))
			...
			904: (e, t, n) => {
				Object.defineProperty(t, '__esModule', { value: !0 })
				const o = n(656),
					i = Spriteset_Battle.prototype.createLowerLayer
				Spriteset_Battle.prototype.createLowerLayer = function () {
					i.call(this),
						o.FilmicFilter.instance || (o.FilmicFilter.instance = new o.FilmicFilter()),
						this._baseSprite.filters.push(o.FilmicFilter.instance)
				}
				const r = Spriteset_Battle.prototype.update
				Spriteset_Battle.prototype.update = function () {
					r.call(this),
						o.FilmicFilter.instance &&
							(o.FilmicFilter.instance.enabled = $gameScreen._lnFilmicFilter.enabled)
				}
			},
			1: (e, t, n) => {
				Object.defineProperty(t, '__esModule', { value: !0 })
				const o = n(656),
					i = Spriteset_Map.prototype.createLowerLayer
				...
				Spriteset_Map.prototype.createWeather = function () {
					;(this._weather = new Weather()), this._baseSprite.addChild(this._weather)
				}
				const r = Spriteset_Map.prototype.update
			...
			538: (e, t, n) => {
				Object.defineProperty(t, '__esModule', { value: !0 })
				const o = n(987),
					i = TouchInput._onMouseDown
				TouchInput._onMouseDown = function (e) {
					;(o.FilterGUI.isPlaytest() && !o.FilterGUI.hiddedn()) || i.call(this, e)
				}
			},
			747: (e) => {
	...
	i(656), i(749), i(957), i(538), i(246), i(974), i(174), i(994), i(557), i(1), i(904), i(644)
})()
