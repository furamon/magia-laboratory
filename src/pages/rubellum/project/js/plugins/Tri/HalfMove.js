...
;(function () {
	...
	Game_Map.prototype.isNoPathByRegionAndTag = function (x, y, terrainParam, regionParam) {
		return this.isIncludeTerrainTag(x, y, terrainParam) || this.isIncludeRegionId(x, y, regionParam)
	}
	...
	Game_Character.prototype.searchLimit = function () {
		return (
			_Game_Character_searchLimit.apply(this, arguments) * (this.isSearchHighPrecision() ? 2 : 1)
		)
	}
	...
	Game_Character.prototype.canDiagonalMove = function () {
		return (
			paramDirection8Move && (param8MoveSwitch > 0 ? $gameSwitches.value(param8MoveSwitch) : true)
		)
	}
	...
	Game_Player.prototype.isHalfStep = function () {
		return (
			paramAdjustmentRealStep && this._realStep && Math.floor(this._realStep) !== this._realStep
		)
	}
	...
	Game_Character.prototype.isHalfMove = function () {
		...
		return (
			Game_CharacterBase.prototype.isHalfMove.call(this) || this.isHalfPosX() || this.isHalfPosY()
		)
	}
