...
;(function () {
	...
	Game_Enemy.prototype.getFormationOffsetX = function () {
		return (
			Game_BattlerBase.prototype.getFormationOffsetX.call(this) *
			($gameSystem.isSideView() ? -1 : 1)
		)
	}
	...
	Game_Unit.prototype.isAliveVanguardMember = function (exceptionBattler) {
		...
		return (
			vanguardMember.length > 0 &&
			(vanguardMember.length > 1 || vanguardMember[0] !== exceptionBattler)
		)
	}
