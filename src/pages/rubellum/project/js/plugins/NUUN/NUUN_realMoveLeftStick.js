...
;(() => {
	...
	Input._gamepadStickRealMove = function () {
		this._stickDashing =
			...
			this._stickMoveing >= DashSpeed / (GamepadLeftStickMaxSpeed + this.getRealMoveDashing()) - 0.5
	}
	...
	Game_Player.prototype.realMoveSpeed = function () {
		return Input.isStickMoveSpeed() > 0
			? Input.isStickMoveSpeed() *
					(!$gameMap.isDashDisabled()
						? GamepadLeftStickMaxSpeed + (this.moveSpeed() - 4) + this.getRealMoveDashing()
						: this.moveSpeed()) *
					2
			: Game_CharacterBase.prototype.realMoveSpeed.call(this)
	}
