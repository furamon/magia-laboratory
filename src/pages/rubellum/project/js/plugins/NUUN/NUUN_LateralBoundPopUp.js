...
;(() => {
	...
	const PopupClass =
		(NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PopupClass']) : null) || []
	...
	Sprite_Battler.prototype.createDamageSprite = function () {
		...
		this._damages[this._damages.length - 1].setupPosition(
			this.x + this.damageOffsetX(),
			this.y + this.damageOffsetY()
		)
	}
	...
	Sprite_Damage.prototype.initialize = function () {
		...
		this._damageClass =
			!!LateralBoundPupupSprite(String(this.constructor.name)) || this._popupMode === 1
