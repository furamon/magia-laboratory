...
;(() => {
	...
	Sprite_Enemy.prototype.updateStateSpriteEx = function () {
		...
		if (this._stateIconSprite) {
			...
			const x =
				(enemy.meta.EnemyStateX ? Number(enemy.meta.EnemyStateX) : 0) +
				State_X +
				this._enemy.getStatePositionX()
			const y =
				(enemy.meta.EnemyStateY ? Number(enemy.meta.EnemyStateY) : 0) +
				State_Y +
				this._enemy.getStatePositionY()
	...
	Sprite_Enemy.prototype.createStateIconSprite = function () {
		...
		if (!this._stateIconSprite) {
			...
			this.battlerOverlay &&
			!this.battlerOverlay.onStateIconSprite &&
