...
;(() => {
	...
	const WindowSkinIndividual =
		(NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['WindowSkinIndividual'])
			: null) || []
	...
	function getSkin() {
		switch (sceneSkinMode) {
			case 'status':
				return StatusHelpWindowSkin && StatusHelpWindowSkin.WindowSkin
					? StatusHelpWindowSkin.WindowSkin
					: null
			case 'save':
				return SaveHelpWindowSkin && SaveHelpWindowSkin.WindowSkin
					? SaveHelpWindowSkin.WindowSkin
					: null
			case 'item':
				return ItemHelpWindowSkin && ItemHelpWindowSkin.WindowSkin
					? ItemHelpWindowSkin.WindowSkin
					: null
			case 'skill':
				return SkillHelpWindowSkin && SkillHelpWindowSkin.WindowSkin
					? SkillHelpWindowSkin.WindowSkin
					: null
			case 'equip':
				return EquipHelpWindowSkin && EquipHelpWindowSkin.WindowSkin
					? EquipHelpWindowSkin.WindowSkin
					: null
			default:
				return null
		}
	...
	function getTone() {
		switch (sceneSkinMode) {
			case 'status':
				return StatusHelpWindowSkin && StatusHelpWindowSkin.WindowColor
					? StatusHelpWindowSkin.WindowColor
					: null
			case 'save':
				return SaveHelpWindowSkin && SaveHelpWindowSkin.WindowColor
					? SaveHelpWindowSkin.WindowColor
					: null
			case 'item':
				return ItemHelpWindowSkin && ItemHelpWindowSkin.WindowColor
					? ItemHelpWindowSkin.WindowColor
					: null
			case 'skill':
				return SkillHelpWindowSkin && SkillHelpWindowSkin.WindowColor
					? SkillHelpWindowSkin.WindowColor
					: null
			case 'equip':
				return EquipHelpWindowSkin && EquipHelpWindowSkin.WindowColor
					? EquipHelpWindowSkin.WindowColor
					: null
			default:
				return null
		}
