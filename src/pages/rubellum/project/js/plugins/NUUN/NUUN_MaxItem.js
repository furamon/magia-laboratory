...
;(() => {
	...
	const CustomDefault =
		(NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['CustomDefault']) : null) ||
		[]
	...
	Game_Party.prototype.getCategoryType = function (item, type) {
		...
		return Imported.NUUN_ItemCategory && item.meta.CategoryType
			? item.meta.CategoryType.trim()
			: getCategoryKeyItem(item, type)
	}
})()
