...
;(() => {
	...
	const CostOrderSetting =
		(NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['CostOrderSetting'])
			: null) || []
	let count = 0
	...
	Window_SkillList.prototype.drawSkillCost = function (skill, x, y, width) {
		...
		CostOrderSetting.forEach((type) => {
			if (type.CostOrderSelect == 'HP') {
				...
				Imported.NUUN_EquipSkillLearning &&
				type.CostOrderSelect == 'EquipSkillLearnSkill'
			) {
