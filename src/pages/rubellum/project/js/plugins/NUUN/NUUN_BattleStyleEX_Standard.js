...
;(() => {
	...
	params.ActorContentsSetting =
		(NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['ActorContentsSetting'])
			: null) || []
	...
	params.DefaultActorImgData =
		(NUUN_Base_Ver >= 113
			...
			: null) || {}
	params.ActorData =
		(NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['ActorData']) : null) || []
	...
	params.NotVisibleStateIcons =
		(NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['NotVisibleStateIcons'])
			: null) || []
	params.NotVisibleBuffIcons =
		(NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['NotVisibleBuffIcons'])
			: null) || []
	...
	params.DamegeVibrationSetting =
		NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['DamegeVibrationSetting'])
			: null
	params.CriticalVibration = eval(parameters['CriticalVibration'] || 'false')
	params.CriticalVibrationSetting =
		NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['CriticalVibrationSetting'])
			: null
	params.BossCollapseVibration = eval(parameters['BossCollapseVibration'] || 'false')
	params.BossCollapseVibrationSetting =
		NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['BossCollapseVibrationSetting'])
			: null
