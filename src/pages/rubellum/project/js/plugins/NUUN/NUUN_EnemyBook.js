...
;(() => {
	...
	const RegistrationTiming =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['RegistrationTiming']) : []
	const RegistrationEnemyColor =
		DataManager.nuun_structureData(parameters['RegistrationEnemyColor']) || 0
	const RegistrationStatusEnemyColor =
		DataManager.nuun_structureData(parameters['RegistrationStatusEnemyColor']) || 0
	...
	const CondBattleCommandEnemyBook =
		NuunManager.getEvalCode(parameters['CondBattleCommandEnemyBook']) || true
	...
	const InfoWindowsSkin =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['InfoWindowsSkin']) : {}

	const PageSetting =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageSetting']) : []
	const PageCols = Number(parameters['PageCols'] || 2)
	const ContentCols = Number(parameters['ContentCols'] || 2)
	const InfoPageSetting =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['InfoPageSetting']) : []
	...
	const AnalyzeSkillMode =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['AnalyzeSkillMode']) : []
	const AnalyzeListData =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['AnalyzeListData']) : []
	const ContentWindowsSkin =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['ContentWindowsSkin']) : {}
	...
	const PercentContent =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PercentContent']) : []
	const Interval = Number(parameters['Interval'] || 0)
	const PercentWindowsSkin =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PercentWindowsSkin']) : {}

	const CategoryNameWindowsSkin =
		NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['CategoryNameWindowsSkin'])
			: {}

	const CategoryShow = eval(parameters['CategoryShow'] || 'true')
	const EnemyBookCategory =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['EnemyBookCategory']) : []
	...
	const CategoryWindowsSkin =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['CategoryWindowsSkin']) : {}
	const CategoryListDateSetting =
		NUUN_Base_Ver >= 113
			? DataManager.nuun_structureData(parameters['CategoryListDateSetting'])
			: []
	...
	const IndexWindowsSkin =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['IndexWindowsSkin']) : {}

	const PageWindowsShow = eval(parameters['PageWindowsShow'] || 'false')
	const PageWindowsSkin =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageWindowsSkin']) : {}
	...
	const ElementList =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['ElementList']) : []
	...
	const StateList =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['StateList']) : []
	...
	const DeBuffList =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['DeBuffList']) : []
	...
	const bookContents = {}
	bookContents.PageList1 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList1']) : []
	bookContents.PageList2 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList2']) : []
	bookContents.PageList3 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList3']) : []
	bookContents.PageList4 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList4']) : []
	bookContents.PageList5 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList5']) : []
	bookContents.PageList6 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList6']) : []
	bookContents.PageList7 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList7']) : []
	bookContents.PageList8 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList8']) : []
	bookContents.PageList9 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList9']) : []
	bookContents.PageList10 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList10']) : []
	bookContents.PageList11 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList11']) : []
	bookContents.PageList12 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList12']) : []
	bookContents.PageList13 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList13']) : []
	bookContents.PageList14 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList14']) : []
	bookContents.PageList15 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList15']) : []
	bookContents.PageList16 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList16']) : []
	bookContents.PageList17 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList17']) : []
	bookContents.PageList18 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList18']) : []
	bookContents.PageList19 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList19']) : []
	bookContents.PageList20 =
		NUUN_Base_Ver >= 113 ? DataManager.nuun_structureData(parameters['PageList20']) : []
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookRegistration', (args) => {
		...
		if (enemyId > 0) {
			$gameSwitches.setValue(
				Number(args.registrationSwitch),
				$gameSystem.isInEnemyBook($dataEnemies[enemyId])
			)
		} else {
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookStatusRegistration', (args) => {
		...
		if (enemyId > 0) {
			$gameSwitches.setValue(
				Number(args.statusRegistrationSwitch),
				$gameSystem.isInEnemyBookStatus($dataEnemies[enemyId])
			)
		} else {
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookGetDropItem', (args) => {
		$gameSystem.dropItemListFlag(
			Number(args.enemyId),
			Number(args.dropListId) - 1,
			true,
			Number(args.dropListId) > 0
		)
	})
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookGetStealItem', (args) => {
		$gameSystem.stealItemListFlag(
			Number(args.enemyId),
			Number(args.stealListId) - 1,
			true,
			Number(args.stealListId) > 0
		)
	})
	...
	PluginManager.registerCommand(pluginName, 'DorpItemAcquired', (args) => {
		$gameSystem.dorpItemAcquired(
			Number(args.DorpItemAcquiredswitch),
			Number(args.enemyId),
			Number(args.DorpItemAcquiredId) - 1
		)
	})

	PluginManager.registerCommand(pluginName, 'StealItemAcquired', (args) => {
		$gameSystem.stealItemAcquired(
			Number(args.StealAcquiredswitch),
			Number(args.enemyId),
			Number(args.stealAcquiredId) - 1
		)
	})

	PluginManager.registerCommand(pluginName, 'EnemyBookActionAdd', (args) => {
		$gameSystem.enemyBookActionList(
			Number(args.enemyId),
			Number(args.actionId) - 1,
			Number(args.actionId) > 0,
			true
		)
	})
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookElementAdd', (args) => {
		...
		$gameSystem.enemyBookElementList(
			Number(args.enemyId),
			Number(args.elementId) - 1,
			Number(args.elementId) > 0,
			true
		)
	})
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookStateAdd', (args) => {
		...
		$gameSystem.enemyBookStateList(
			Number(args.enemyId),
			Number(args.stateId) - 1,
			Number(args.stateId) > 0,
			true
		)
	})
	...
	PluginManager.registerCommand(pluginName, 'EnemyBookDebuffAdd', (args) => {
		...
		$gameSystem.enemyBookDebuffList(
			Number(args.enemyId),
			Number(args.debuffId) - 1,
			Number(args.debuffId) > 0,
			true
		)
	})
	...
	Game_System.prototype.isInEnemyBook = function (enemy) {
		return (
			enemy &&
			enemy.name &&
			this.noEnemyBookEnemyName(enemy) &&
			this._enemyBookFlags &&
			this._enemyBookFlags[enemy.id]
		)
	}
	...
	Game_System.prototype.isInEnemyBookStatus = function (enemy) {
		return (
			...
			this.noEnemyBookEnemyName(enemy) &&
			this._enemyBookStatusFlags &&
			this._enemyBookStatusFlags[enemy.id]
		)
	}
	...
	Game_System.prototype.isEnemyBook = function (enemy) {
		...
		return (
			...
			enemy.name &&
			this.noEnemyBookEnemyName(enemy) &&
			!enemy.meta[NoBookTag] &&
			!enemy.meta[NoBookDataTag]
		)
	}

	Game_System.prototype.isEnemyBookData = function (enemy) {
		//データベース
	...
	Game_System.prototype.setDefeatEnemy = function (enemyList) {
		...
		this._defeatEnemy = enemy.reduce((r, enemy) => {
			return (
				...
				enemy.name &&
				this.noEnemyBookEnemyName(enemy) &&
				(this.defeatNumber(enemy.id) > 0 ||
					(enemy.meta.ShowDataBook && !enemy.meta[NoBookTag] && !enemy.meta[NoBookDataTag]))
					? 1
					: 0)
			)
		}, 0)
	...
	Game_System.prototype.registrationTiming = function (mode) {
		return RegistrationTiming.some(
			(data) => data.RegistrationTiming === mode && !data.RegisterStatus
		)
	}
	...
	Game_System.prototype.registrationStatusNoTransform = function () {
		return RegistrationTiming.some((data) => {
			;(data.RegistrationTiming === 0 ||
				data.RegistrationTiming === 1 ||
				data.RegistrationTiming === 4) &&
				data.RegisterStatus
		})
	}
	...
	Game_System.prototype.getEnemyBookActionFlag = function (enemyId, actionId) {
		if (
			!this._enemyBookActionFlags ||
			!this._enemyBookActionFlags[enemyId] ||
			!this._enemyBookActionFlags[enemyId][actionId]
		) {
			return false
		}
	...
	Game_System.prototype.getEnemyBookElementFlag = function (enemyId, elementId) {
		if (
			...
			!this._enemyBookElementFlags[enemyId][elementId]
		) {
			return false
		}
	...
	Game_System.prototype.getEnemyBookStateFlag = function (enemyId, stateId) {
		if (
			!this._enemyBookStateFlags ||
			!this._enemyBookStateFlags[enemyId] ||
			!this._enemyBookStateFlags[enemyId][stateId]
		) {
			return false
		}
	...
	Game_System.prototype.getEnemyBookDebuffFlag = function (enemyId, debuffId) {
		if (
			!this._enemyBookDebuffFlags ||
			!this._enemyBookDebuffFlags[enemyId] ||
			!this._enemyBookDebuffFlags[enemyId][debuffId]
		) {
			return false
		}
	...
	Game_Action.prototype.analyzeSkill = function (target) {
		if (target.isEnemy() && $gameSystem.isEnemyBookData(target.enemy())) {
			const data = this.item().meta.AnalyzeSkill
				? this.item().meta.AnalyzeSkill.split(',').map(Number)
				: [-1]
			if (data[0] >= 0) {
				...
				if (analyzeSkill) {
					...
					const rate =
						this.item().meta.CertainAnalyze || !target.enemy().meta.AnalyzeResist
							? 100
							: Number(target.enemy().meta.AnalyzeResist)
					if (Math.floor(Math.random() * 100 >= rate)) {
						target.result().missed = true
						BattleManager.analyzeMissMessage = analyzeSkill.AnalyzeMissMessage.format(
							target.name(),
							this.subject().name()
						)
						return
	...
	Scene_EnemyBook.prototype.backgroundRefresh = function () {
		...
		if (BackFitWidth) {
			if (BackUiWidth) {
				...
				sprite.scale.x =
					Graphics.width !== sprite.bitmap.width ? Graphics.width / sprite.bitmap.width : 1
				sprite.scale.y =
					Graphics.height !== sprite.bitmap.height ? Graphics.height / sprite.bitmap.height : 1
			}
		}
	}
	...
	Scene_EnemyBook.prototype.enemyWindowPageRect = function () {
		...
		const wh = this.calcWindowHeight(1, true)
		const wy = PageWindowsShow
			? this.mainAreaTop()
			: (wh + (Graphics.height - Graphics.boxHeight) / 2) * -1
	...
	Scene_EnemyBook.prototype.indexWindowRect = function () {
		const height =
			(this._percentWindow ? this._percentWindow.height : 0) +
			(this._categoryNameWindow ? this._categoryNameWindow.height : 0)
		const wx = WindowMode === 0 ? 0 : this.enemyWindowWidth()
	...
	Scene_EnemyBook.prototype.setEnemyBookButton = function () {
		if (this._cancelButton && this._enemyBook_downButton && this._enemyBook_upButton) {
			this._enemyBook_downButton.x =
				(this._cancelButton ? this._cancelButton.x - 20 : 0) - this._enemyBook_downButton.width
	...
	Scene_EnemyBook.prototype.updatePageupdownButton = function () {
		if (this._enemyBook_downButton) {
			this._enemyBook_downButton.visible =
				this._enemyPageWindow.active && this.updatePageupdownButtonBookMode()
		}
		if (this._enemyBook_upButton) {
			this._enemyBook_upButton.visible =
				this._enemyPageWindow.active && this.updatePageupdownButtonBookMode()
		}
	}
	...
	Scene_Battle.prototype.setEnemyBookButton = function () {
		...
		if (this._enemyBook_downButton && this._enemyBook_upButton) {
			this._enemyBook_downButton.x =
				(this._enemyBook_cancelButton ? this._enemyBook_cancelButton.x - 20 : 0) -
				this._enemyBook_downButton.width
	...
	Scene_Battle.prototype.enemyBookCategoryNameWindowRect = function () {
		const wx = WindowMode === 0 ? 0 : this.enemyBookWindowWidth()
		const wy =
			this.enemyBookMainAreaTop() +
			(this._enemyBookPercentWindow ? this._enemyBookPercentWindow.height : 0)
		const ww = this.enemyBookIndexWidth()
	...
	Scene_Battle.prototype.enemyBookIndexWindowRect = function () {
		const height =
			(this._enemyBookPercentWindow ? this._enemyBookPercentWindow.height : 0) +
			(this._enemyBookCategoryNameWindow ? this._enemyBookCategoryNameWindow.height : 0)
		const wx = WindowMode === 0 ? 0 : this.enemyBookWindowWidth()
		const wy = this.enemyBookMainAreaTop() + height
		const ww = this.enemyBookIndexWidth()
		const wh = this.enemyBookMainAreaHeight() - height
	...
	Scene_Battle.prototype.updatePageCancelButton = function () {
		if (this._enemyBook_cancelButton) {
			this._enemyBook_cancelButton.visible =
				this._enemyBookPageWindow.active ||
	...
	Scene_Battle.prototype.updatePageupdownButton = function () {
		if (this._enemyBook_downButton) {
			this._enemyBook_downButton.visible =
				this._enemyBookPageWindow.active && this.updatePageupdownButtonBookMode()
		}
		if (this._enemyBook_upButton) {
			this._enemyBook_upButton.visible =
				this._enemyBookPageWindow.active && this.updatePageupdownButtonBookMode()
	...
	Scene_Battle.prototype.setEnemyBook = function () {
		...
		this._enemyBookPageWindow.y =
			pageRect.y -
			(this.pageWindowsShowMode(PageSetting) ? 0 : this._enemyBookPageWindow.height + pageRect.y) +
			this.enemyBookWindowUi_Y() -
		...
		this._enemyBookEnemyWindow.y =
			rect.y +
			(this.pageWindowsShowMode(PageSetting) ? this._enemyBookPageWindow.height : 0) +
			this.enemyBookWindowUi_Y()
		this._enemyBookEnemyWindow.width = rect.width
		this._enemyBookEnemyWindow.height =
			rect.height -
			(rect.y + (this.pageWindowsShowMode(PageSetting) ? this._enemyBookPageWindow.height : 0))
	...
	Scene_Battle.prototype.setEnemyBookInfo = function () {
		...
		this._enemyBookPageWindow.y =
			pageRect.y -
			(this.pageWindowsShowMode(InfoPageSetting)
				? 0
				: this._enemyBookPageWindow.height + pageRect.y) +
			this.enemyBookWindowUi_Y() -
			(Graphics.height - Graphics.boxHeight) / 2
		this._enemyBookEnemyWindow.x = rect.x + this.enemyBookWindowUi_X()
		this._enemyBookPageWindow.x = this._enemyBookEnemyWindow.x
		this._enemyBookEnemyWindow.y =
			rect.y +
			(this.pageWindowsShowMode(InfoPageSetting) ? this._enemyBookPageWindow.height : 0) +
			this.enemyBookWindowUi_Y()
		this._enemyBookEnemyWindow.width = rect.width
		this._enemyBookEnemyWindow.height =
			rect.height -
			(rect.y + (this.pageWindowsShowMode(InfoPageSetting) ? this._enemyBookPageWindow.height : 0))
	...
	Scene_Battle.prototype.setEnemyBookEnemyAnalyze = function (target, analyzeDate) {
		...
		this._enemyBookPageWindow.y =
			pageRect.y -
			(this.pageWindowsShowMode(data) ? 0 : this._enemyBookPageWindow.height + pageRect.y) +
			this.enemyBookWindowUi_Y() -
			(Graphics.height - Graphics.boxHeight) / 2
		...
		this._enemyBookEnemyWindow.y =
			rect.y +
			(this.pageWindowsShowMode(data) ? this._enemyBookPageWindow.height : 0) +
			this.enemyBookWindowUi_Y()
		this._enemyBookEnemyWindow.width = rect.width
		this._enemyBookEnemyWindow.height =
			rect.height -
			(rect.y + (this.pageWindowsShowMode(data) ? this._enemyBookPageWindow.height : 0))
	...
	Window_EnemyBook_Percent.prototype.getPercentParam = function (content) {
		...
		switch (content.ContentDate) {
			...
			case 1:
				return (
					content.ContentName + ' : ' + this._encountered.encNum + '/' + this._encountered.length
				)
			case 2:
	...
	Window_EnemyBook_Index.prototype.drawItem = function (index) {
		...
		if (enemy) {
			...
			if (NumberType > 0) {
				...
				this.drawText(
					name,
					rect.x + textWidth + 24 + textMargin,
					rect.y,
					itemWidth - textWidth - 24
				)
			} else {
				if (iconId > 0) {
					const iconY = rect.y + (this.lineHeight() - ImageManager.iconHeight) / 2
	...
	Window_EnemyBookPage.prototype.makeCommandList = function () {
		if (
			(this._data && this._indexWindow && this._indexWindow.active) ||
			(this._infoIndexWindow && this._infoIndexWindow.active)
		) {
	...
	Window_EnemyBook.prototype.condDropItemFlag = function (index) {
		return Imported.NUUN_EnemyBookEX_2 && this.getShowCondDropItemName()
			? $gameSystem.getCondDropItemFlag(this._enemy.id, index)
			: true
	}
	...
	Window_EnemyBook.prototype.onElementsFlag = function (index) {
		return Imported.NUUN_EnemyBookEX_1 && ShowElementsIcon && index >= 0
			? $gameSystem.getEnemyBookElementFlag(this._enemy.id, index)
			: true
	}

	Window_EnemyBook.prototype.onStateFlag = function (index) {
		return Imported.NUUN_EnemyBookEX_1 && ShowStateIcon
			? $gameSystem.getEnemyBookStateFlag(this._enemy.id, index)
			: true
	}

	Window_EnemyBook.prototype.onDebuffFlag = function (index) {
		return Imported.NUUN_EnemyBookEX_1 && ShowDebuffIcon
			? $gameSystem.getEnemyBookDebuffFlag(this._enemy.id, index)
			: true
	}
	...
	Window_EnemyBook.prototype.isEnemyData = function () {
		return (
			$gameSystem.isEnemyBook(this._enemy) &&
			((UnregisteredEnemy === 0 && $gameSystem.isInEnemyBook(this._enemy)) || UnregisteredEnemy > 0)
		)
	}
		...
		for (const data of listContents) {
			...
			const width =
				data.ItemWidth && data.ItemWidth > 0
					? Math.min(data.ItemWidth, rect.width - data.X_Coordinate)
					: this.widthMode(data, rect)
	...
	Window_EnemyBook.prototype.loadBitmap = function () {
		...
		listContents.forEach((list) => {
			switch (list.DateSelect) {
				...
				case 251:
					const meta = this._categoryMode
						? this._categoryData[list.textMethod]
						: this._enemy.meta[list.textMethod]
	...
	Window_EnemyBook.prototype.enemyImg = function (list, enemy, x, y, width) {
		...
		this._enemySprite.setup(
			enemy,
			width / 2 + x + itemPadding * 2,
			y + height / 2 + itemPadding * 2,
			this.paramMask(list.MaskMode)
		)
	}
	...
	Window_EnemyBook.prototype.stealItems = function (list, enemy, x, y, width) {
		if (Imported.NUUN_StealableItems) {
			...
			this.drawText(
				'盗みスキルプラグイン(NUUN_StealableItems)が導入されていません。',
				x,
				y,
				width,
				'left'
	...
	Window_EnemyBook.prototype.condDropItems = function (list, enemy, x, y, width) {
		if (Imported.NUUN_ConditionalDrops && Imported.NUUN_EnemyBookEX_2) {
			...
			this.drawText(
				'条件付きドロップアイテムプラグイン(Imported.NUUN_ConditionalDrops)が導入されていません。',
				x,
				y,
				width,
				'left'
		...
		ElementList.forEach((element, i) => {
			...
			if (element.ElementNo && element.ElementNo !== 0) {
				if (element.ElementIconId > 0 && ResistWeakElementMode >= 1) {
					const iconId =
						ElementUnknownIconId > 0 && this.onElementsFlag(element.ElementNo)
							? ElementUnknownIconId
				...
				if (ResistWeakElementMode !== 1) {
					...
					this.changeTextColor(NuunManager.getColorCode(list.NameColor))
					const elementText = this.onElementsFlag(element.ElementNo)
						? getElementTextName(element.ElementNo)
						: UnknownStatus
				...
				if (this.resistWeakDataMask(list.MaskMode)) {
					...
					this.drawText(
						rateText,
						x2 + textWidth + this.itemPadding(),
						y2,
						width2 - (textWidth + this.itemPadding()),
						'right'
					)
				} else {
					this.resetTextColor()
			...
			if (state.StateId) {
				...
				if (stateId > 0) {
					if ($dataStates[stateId].iconIndex > 0 && ResistWeakStateMode >= 1) {
						const iconId =
							StateUnknownIconId > 0 && this.onStateFlag(stateId)
								? StateUnknownIconId
	...
	Window_EnemyBook.prototype.drawWeakStates = function (list, enemy, x, y, width) {
		...
		StateList.forEach((state) => {
			...
			if (state.StateId > 0) {
				...
				let rate = enemy.stateRate(stateId)
				if (
					((!NormalWeakState && rate > 1) || (NormalWeakState && rate >= 1)) &&
					!enemy.isStateResist(stateId)
				) {
					if (Unknown || (StateUnknownIconId > 0 && !this.onStateFlag(stateId))) {
						icon = StateUnknownIconId
					} else {
	...
	Window_EnemyBook.prototype.enemyElementChart = function (list, enemy, x, y, width) {
		...
		this.drawText(nameText, x + margin, y, width - margin)
		const lineHeight = this.lineHeight()
		this.enemyElementRadarChart(
			this.setEnemyElementChart(enemy),
			enemy,
			x,
			y + lineHeight,
			'element'
	...
	Window_EnemyBook.prototype.numberWidthSlice = function (indexText) {
		return $gameSystem._enemyBookLength >= 1000
			? ('0000' + indexText).slice(-4)
			: ('000' + indexText).slice(-3)
	}
	...
	Window_BattleEnemyBook.prototype.getEnemyStatusList = function () {
		switch (this._mode) {
			...
			case 'analyze':
				...
				return id > 0 && AnalyzeListData[id - 1]
					? AnalyzeListData[id - 1].AnalyzePageList
					: PageSetting
		}
	}
	...
	Window_BattleEnemyBook.prototype.isEnemyData = function () {
		...
		switch (this._mode) {
			case 'book':
				return (
					$gameSystem.isEnemyBook(this._enemy) &&
					((UnregisteredEnemy === 0 && $gameSystem.isInEnemyBook(this._enemy)) ||
						UnregisteredEnemy > 0)
				)
			case 'info':
				return (
		...
		if (this.statusMode()) {
			if (list.DateSelect === 1 && enemy.isDying()) {
				...
				this.changeTextColor(
					this.buffColor(this.paramShow(list, enemy), this.normalParam(list, enemy))
				)
			}
		}
	}
	...
	Window_EnemyBook.prototype.buffColor = function (params, nparams) {
		const _buffColor =
			this._mode === 'info'
				? BuffColor
				: this._contentsData
					? this._contentsData.BuffColor
					: BuffColor
		const _debuffColor =
			this._mode === 'info'
				? DebuffColor
				: this._contentsData
					? this._contentsData.DebuffColor
					: DebuffColor
		if (params > nparams) {
	...
	Window_Command.prototype.isEnemyBook = function () {
		return (
			ShowBattleCommand &&
			($gameSwitches.value(enemyBookBattleSwitch) || enemyBookBattleSwitch === 0)
		)
	}

	Window_Command.prototype.isEnemyInfo = function () {
		return (
			ShowEnemyInfoCommand &&
			($gameSwitches.value(enemyBookInfoSwitch) || enemyBookInfoSwitch === 0)
		)
	}
	...
	Sprite_BookEnemy.prototype.setSvActor = function () {
		const motionIndex = this._battler.enemy().meta.EB_SVBattlerMotion
			? Number(this._battler.enemy().meta.EB_SVBattlerMotion)
			: 0
	...
	BattleManager.setEnemyBookAction = function () {
		...
		if (subject.isEnemy() && this._action) {
			const actionId = subject
				.enemy()
				.actions.findIndex((action) => action.skillId === this._action.item().id)
