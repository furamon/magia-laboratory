...
;(() => {
	...
	for (const name of _methodNames) {
		Sprite_ActorTimelineIcon.prototype[name] = Sprite_EnemyTimelineIcon.prototype[name]
	}
	...
	const _Sprite_ActorTimelineIcon_setCharacterBitmap =
		Sprite_ActorTimelineIcon.prototype.setCharacterBitmap
