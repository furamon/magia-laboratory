...
;(() => {
	...
	const _pluginOptions = ['MPP_MiniMap_Op1', 'MPP_MiniMap_Op2', 'MPP_MiniMap_Op3']
	...
	Game_MinimapMarker.prototype.subject = function () {
		...
		if (this._vehicleType) {
			...
			return this._mapId === $gameMap.mapId() ? $gameMap.event(this._eventId) : null
		}
	}
	...
	Game_MinimapMarker.prototype.isVisible = function () {
		...
		const subject = this.subject()
		return subject ? subject.isMinimapMarkerVisible() : this._mapId === $gameMap.mapId()
	}
	...
	Game_Minimap.prototype.params = function () {
		return this._paramsIndex > 0 ? param_DisplayPositions[this._paramsIndex - 1] : null
	}
	...
	Game_Minimap.prototype.zoomTo = function (zoom) {
		this._zoom = zoom || this.metadataZoom() || this.paramsZoom() || this._targetZoom
		this._targetZoom = this._zoom
		this.refreshZoom()
		this.updateScroll()
	}
	...
	Game_Minimap.prototype.smoothZoomTo = function (zoom) {
		this._targetZoom = zoom || this.metadataZoom() || this.paramsZoom() || this._targetZoom
		this.refreshZoom()
	...
	Game_Player.prototype.isMinimapMarkerVisible = function () {
		return (
			this._vehicleType !== 'walk' || Game_Character.prototype.isMinimapMarkerVisible.call(this)
		)
	}
	...
	Game_Vehicle.prototype.isMinimapMarkerVisible = function () {
		return !this._driving && Game_Character.prototype.isMinimapMarkerVisible.call(this)
	}
	...
	MinimapImage.minZoom = function () {
		...
		if (params && this.bitmap.isReady()) {
			const minRate = Math.min(params.Width / this.bitmap.width, params.Height / this.bitmap.height)
	...
	Sprite_MiniMap.prototype.setSpriteOpacity = function (sprite, marker) {
		const opacity = marker.isBlink() ? (255 * this._blinkDuration) / param_BlinkDuration : 255
	...
	Sprite_MiniMap.prototype.correctionPos = function (x, y) {
		...
		return [sx + hw, sy + hh, sx !== x - hw || sy !== y - hh ? Math.atan2(sy, sx) : NaN]
	}
