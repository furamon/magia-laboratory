...
;(() => {
	...
	Tilemap.prototype._moveDarkness = function (x, y) {
		...
		if (this._additiveLayer) {
			...
			this._additiveLayer.opacity = ($gameMap.darknessOpacity() * param_AdditiveAlpha) / 100
		}
	}
	...
	Tilemap.prototype._paintDarknessAllLight = function (layer, sx, sy) {
		...
		allMapLights.sort((a, b) => {
			return a.priority() - b.priority() || allMapLights.indexOf(a) - allMapLights.indexOf(b)
		})
	...
	Game_MapLight.prototype.rgb = function () {
		return this._colorIndex > 0 ? param_LightColors[this._colorIndex - 1] : null
	}
	...
	Game_MapLight.prototype.isValid = function () {
		return (this._radius > 0 || this._isFront) && this._opacity > 0 && this.rgb()
	}

	Game_MapLight.prototype.setCharLight = function (eventId, radius, colorIndex, amplitude) {
		this._isFront = false
	...
	Game_MapLight.prototype.setPosLight = function (x, y, radius, colorIndex, amplitude) {
		this._isFront = false
		this._x = x
		this._y = y
		this._targetRadius = radius
	...
	Game_MapLight.prototype.setFrontLight = function (eventId, colorIndex, amplitude) {
		this._eventId = eventId
		const subject = this.subject()
		this._isFront = true
		this._colorIndex = colorIndex
