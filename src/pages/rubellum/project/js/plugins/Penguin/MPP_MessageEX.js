...
;(() => {
	...
	const getTextColor = function (index) {
		return Utils.RPGMAKER_NAME === 'MV' ? this.textColor(index) : ColorManager.textColor(index)
	}
	...
	Game_Map.prototype.isAnyMoveRouteForcingNr = function () {
		return this.events().some((e) => e.isMoveRouteForcingNr()) || $gamePlayer.isMoveRouteForcingNr()
	}

	Game_Map.prototype.isAnyAnimationPlaying = function () {
		return this.events().some((e) => e.isAnimationPlaying()) || $gamePlayer.isAnimationPlaying()
	}

	Game_Map.prototype.isAnyBalloonPlaying = function () {
		return this.events().some((e) => e.isBalloonPlaying()) || $gamePlayer.isBalloonPlaying()
	}
