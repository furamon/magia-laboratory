...
;(function () {
	...
	Game_BattlerBase.prototype.push = function (target, distance, type) {
		...
		return targetEvent.srpgTryMove(
			10 - targetEvent.dirTo(userEvent.posX(), userEvent.posY()),
			distance,
			type
		)
	}
	...
	Game_BattlerBase.prototype.pull = function (target, distance, type) {
		...
		return targetEvent.srpgTryMove(
			targetEvent.dirTo(userEvent.posX(), userEvent.posY()),
			distance,
			type
		)
	}
	...
	Game_BattlerBase.prototype.pushAoE = function (target, distance, type) {
		...
		return targetEvent.srpgTryMove(
			10 - targetEvent.dirTo($gameTemp.areaX(), $gameTemp.areaY()),
			distance,
			type
		)
	}
	...
	Game_BattlerBase.prototype.pullAoE = function (target, distance, type) {
		...
		if (
			!$gameTemp.areaX ||
			!$gameTemp.areaY ||
			targetEvent.pos($gameTemp.areaX(), $gameTemp.areaY())
		)
			return 0

		return targetEvent.srpgTryMove(
			targetEvent.dirTo($gameTemp.areaX(), $gameTemp.areaY()),
			distance,
			type
		)
	}
