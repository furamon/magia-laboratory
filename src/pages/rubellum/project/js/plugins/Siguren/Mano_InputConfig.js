...
const Mano_InputConfig = (function () {
	...
	class SymbolManager_T {
		...
		*iterateSymbolList() {
		 ...
		 */
		getSymbolList() {
			return this._basicSymbols.concat(this._extendSymbols, this._unknowList, this._moveSymbols)
		}
	...
	const symbolManager = new SymbolManager_T(createBasicSymbols(), createMoveSymbols())
	...
	class Key_CommandManager_T {
		...
		createCommandList_ForKeyLayout() {
			const commandList = [this._reset, this._apply, this._wasd, this._changeLayout, this._exit]
			const result = []
