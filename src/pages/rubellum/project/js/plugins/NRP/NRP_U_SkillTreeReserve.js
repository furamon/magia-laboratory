...
;(() => {
	...
	// 本体プラグインのパラメータ
	const skillTreeParams = PluginParamsParser.parse(
		PluginManager.parameters(SkillTreePluginName),
		{}
	)
	...
	// レイアウトプラグインのパラメータ
	const layoutParams = PluginParamsParser.parse(
		PluginManager.parameters(SkillTree_LayoutExPluginName),
		typeDefine
	)
	...
	Scene_SkillTree.prototype.createNodeOpenReserveWindow = function () {
		this._windowNodeOpenReserve = new Window_NodeOpenReserve(
	...
	Game_Interpreter.prototype.terminate = function () {
		...
		if (mReserveSkillTreeActorId && $gameMap._interpreter == this && !$gameMessage.hasText()) {
			skt_open(mReserveSkillTreeActorId)
		}
	}
