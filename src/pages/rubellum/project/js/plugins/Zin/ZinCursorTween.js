...
;(() => {
	...
	Window_Base.prototype.doLoopCursorTween = function () {
		...
		this._cursorSprite
			.ztAlphaTo(param.cursorNormalTween.alpha, param.cursorNormalTween.duration)
			.setDelay(param.cursorNormalTween.delay)
			.setEase(easing)
			.setWrapMode(wrapMode)
			.setCycleNum(loopNum)
		if (
			param.cursorNormalTween.toneR != 0 ||
			param.cursorNormalTween.toneG != 0 ||
			param.cursorNormalTween.toneB != 0 ||
			param.cursorNormalTween.toneGray != 0
		) {
			this._cursorSprite.setColorTone([0, 0, 0, 0])
			this._cursorSprite
				.ztColorTo(
					[
						param.cursorNormalTween.toneR,
						param.cursorNormalTween.toneG,
						param.cursorNormalTween.toneB,
						param.cursorNormalTween.toneGray
					],
					param.cursorNormalTween.duration
				)
				.setDelay(param.cursorNormalTween.delay)
				.setEase(easing)
				.setWrapMode(wrapMode)
		...
		if (param.cursorNormalTween.hue != 0) {
			...
			this._cursorSprite
				.ztHueTo(param.cursorNormalTween.hue, param.cursorNormalTween.duration)
				.setDelay(param.cursorNormalTween.delay)
				.setEase(easing)
				.setWrapMode(wrapMode)
				.setCycleNum(loopNum)
	...
	Window_Base.prototype.doPressCursorTween = function () {
		...
		this._cursorSprite
			.ztAlphaTo(param.cursorPressTween.alpha, param.cursorPressTween.duration)
			.setDelay(param.cursorPressTween.delay)
			.setEase(easing)
			.setWrapMode(WrapMode.Pingpong)
		if (
			param.cursorPressTween.toneR != 0 ||
			param.cursorPressTween.toneG != 0 ||
			param.cursorPressTween.toneB != 0 ||
			param.cursorPressTween.toneGray != 0
		) {
			this._cursorSprite
				.ztColorTo(
					[
						param.cursorPressTween.toneR,
						param.cursorPressTween.toneG,
						param.cursorPressTween.toneB,
						param.cursorPressTween.toneGray
					],
					param.cursorPressTween.duration
				)
				.setDelay(param.cursorPressTween.delay)
				.setEase(easing)
				.setWrapMode(WrapMode.Pingpong)
		...
		if (param.cursorPressTween.hue != 0) {
			this._cursorSprite
				.ztHueTo(param.cursorPressTween.hue, param.cursorPressTween.duration)
				.setDelay(param.cursorPressTween.delay)
				.setEase(easing)
				.setWrapMode(WrapMode.Pingpong)
		}
	...
	Window_Base.prototype.doViewCursorTween = function () {
		...
		if (wrapMode == WrapMode.Clamp) loopNum = 0
		this._cursorSprite
			.ztAlphaTo(param.cursorViewTween.alpha, param.cursorViewTween.duration)
			.setDelay(param.cursorViewTween.delay)
			.setEase(easing)
			.setWrapMode(wrapMode)
			.setCycleNum(loopNum)
		if (
			param.cursorViewTween.toneR != 0 ||
			param.cursorViewTween.toneG != 0 ||
			param.cursorViewTween.toneB != 0 ||
			param.cursorViewTween.toneGray != 0
		) {
			this._cursorSprite
				.ztColorTo(
					[
						param.cursorViewTween.toneR,
						param.cursorViewTween.toneG,
						param.cursorViewTween.toneB,
						param.cursorViewTween.toneGray
					],
					param.cursorViewTween.duration
				)
				.setDelay(param.cursorViewTween.delay)
				.setEase(easing)
				.setWrapMode(wrapMode)
		...
		if (param.cursorViewTween.hue != 0) {
			this._cursorSprite
				.ztHueTo(param.cursorViewTween.hue, param.cursorViewTween.duration)
				.setDelay(param.cursorViewTween.delay)
				.setEase(easing)
				.setWrapMode(wrapMode)
				.setCycleNum(loopNum)
	...
	Window_Base.prototype.doMoveCursorTween = function () {
		...
		if (param.cursorMoveTween.textEnabled) {
			...
			this.ztNumberTo(
				'_hoverTweenColorR',
				param.cursorMoveTween.textColor.r,
				param.cursorMoveTween.duration
			)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo(
				'_hoverTweenColorG',
				param.cursorMoveTween.textColor.g,
				param.cursorMoveTween.duration
			)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo(
				'_hoverTweenColorB',
				param.cursorMoveTween.textColor.b,
				param.cursorMoveTween.duration
			)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			...
			this.ztNumberTo(
				'_outlineHoverTweenColorR',
				param.cursorMoveTween.textOutlineColor.r,
				param.cursorMoveTween.duration
			)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo(
				'_outlineHoverTweenColorG',
				param.cursorMoveTween.textOutlineColor.g,
				param.cursorMoveTween.duration
			)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo(
				'_outlineHoverTweenColorB',
				param.cursorMoveTween.textOutlineColor.b,
				param.cursorMoveTween.duration
			)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
		...
		if (
			param.cursorMoveTween.toneR != 0 ||
			param.cursorMoveTween.toneG != 0 ||
			param.cursorMoveTween.toneB != 0 ||
			param.cursorMoveTween.toneGray != 0
		) {
			this._cursorSprite.setColorTone([0, 0, 0, 0])
			this._cursorSprite
				.ztColorFrom(
					[
						param.cursorMoveTween.toneR,
						param.cursorMoveTween.toneG,
						param.cursorMoveTween.toneB,
						param.cursorMoveTween.toneGray
					],
					param.cursorMoveTween.duration
				)
				.setDelay(param.cursorMoveTween.delay)
		...
		if (param.cursorMoveTween.hue != 0) {
			this._cursorSprite
				.ztHueFrom(param.cursorMoveTween.hue, param.cursorMoveTween.duration)
				.setDelay(param.cursorMoveTween.delay)
				.setEase(easing)
		}
	}
	...
	Window_Base.prototype.doCloseCursorTween = function () {
		...
		if (param.cursorMoveTween.textEnabled) {
			this.ztNumberTo('_hoverTweenColorR', 0, param.cursorMoveTween.duration)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo('_hoverTweenColorG', 0, param.cursorMoveTween.duration)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo('_hoverTweenColorB', 0, param.cursorMoveTween.duration)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)

			this.ztNumberTo('_outlineHoverTweenColorR', 0, param.cursorMoveTween.duration)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo('_outlineHoverTweenColorG', 0, param.cursorMoveTween.duration)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
			this.ztNumberTo('_outlineHoverTweenColorB', 0, param.cursorMoveTween.duration)
				.setEase(easing)
				.setDelay(param.cursorMoveTween.delay)
		}
	}
	...
	Window_Selectable.prototype.setCursorRect = function (x, y, width, height) {
		...
		if (this._isAvtivateCursor && this._index != this._indexOld && this._index != -1) {
			...
			if (param.cursorMoveTween.moveEnabled) {
				this._cursorMoveTween = this.ztCursorMoveFrom(oldX, oldY, param.cursorMoveTween.duration)
					.setEase(easing)
					.setDelay(param.cursorMoveTween.delay)
			}
			...
			if (param.cursorMoveTween.scaleEnabled) {
				...
				this.ztCursorScaleFrom(l, h, param.cursorMoveTween.duration)
					.setDelay(param.cursorMoveTween.delay)
					.setEase(easing)
			}

			if (param.debugMode)
				console.log('CursorTween >> setCursorRect: カーソル移動トゥイーン index = ' + this._index)
		...
		for (let i = 0; i < this.maxVisibleItems(); i++) {
			...
			if (index < this.maxItems()) {
				...
				if (this._currentIndex == index && param.cursorMoveTween.textEnabled) {
					this._hoverColor = ZinTween.GetColorCode({
						r: this._hoverTweenColorR,
						g: this._hoverTweenColorG,
						b: this._hoverTweenColorB,
						a: 255
					})
					this._outlineHoverColor = ZinTween.GetColorCode({
						r: this._outlineHoverTweenColorR,
						g: this._outlineHoverTweenColorG,
						b: this._outlineHoverTweenColorB,
						a: 255
					})
				} else {
	...
	Window.prototype.updateTransform = function () {
		...
		if (
			this instanceof Window_Selectable &&
			!(this instanceof Window_ShopNumber) &&
			!(this instanceof Window_NameEdit) &&
			this._index != -1
		) {
			this.paint()
		}
