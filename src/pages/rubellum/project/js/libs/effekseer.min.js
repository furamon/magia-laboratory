...
var effekseer_native = (function () {
	...
	return function (effekseer_native) {
		...
		var wasmMemory
		var wasmTable = new WebAssembly.Table({ initial: 1296, maximum: 1296 + 0, element: 'anyfunc' })
		var ABORT = false
		var EXITSTATUS = 0
			...
			updateSourceTime: function (src) {
				...
				if (src.bufsProcessed >= src.bufQueue.length && !src.looping) {
					...
					if (src.type !== 4136 && src.looping) {
						...
						if (srcDuration > 0) {
							src.bufStartTime +=
								Math.floor((currentTime - src.bufStartTime) / srcDuration) * srcDuration
						}
					}
		...
		var _EffekseerInit = (Module['_EffekseerInit'] = function () {
			return (_EffekseerInit = Module['_EffekseerInit'] = Module['asm']['EffekseerInit']).apply(
				null,
				arguments
			)
		})
		...
		var _EffekseerDraw = (Module['_EffekseerDraw'] = function () {
			return (_EffekseerDraw = Module['_EffekseerDraw'] = Module['asm']['EffekseerDraw']).apply(
				null,
				arguments
			)
		})
		...
		var _EffekseerSetProjectionMatrix = (Module['_EffekseerSetProjectionMatrix'] = function () {
			return (_EffekseerSetProjectionMatrix = Module['_EffekseerSetProjectionMatrix'] =
				Module['asm']['EffekseerSetProjectionMatrix']).apply(null, arguments)
		})
		var _EffekseerSetProjectionPerspective = (Module['_EffekseerSetProjectionPerspective'] =
			function () {
				return (_EffekseerSetProjectionPerspective = Module['_EffekseerSetProjectionPerspective'] =
					Module['asm']['EffekseerSetProjectionPerspective']).apply(null, arguments)
			})
		var _EffekseerSetProjectionOrthographic = (Module['_EffekseerSetProjectionOrthographic'] =
			function () {
				return (_EffekseerSetProjectionOrthographic = Module[
					'_EffekseerSetProjectionOrthographic'
				] =
					Module['asm']['EffekseerSetProjectionOrthographic']).apply(null, arguments)
			})
		var _EffekseerSetCameraMatrix = (Module['_EffekseerSetCameraMatrix'] = function () {
			return (_EffekseerSetCameraMatrix = Module['_EffekseerSetCameraMatrix'] =
		...
		var _EffekseerSetCameraLookAt = (Module['_EffekseerSetCameraLookAt'] = function () {
			return (_EffekseerSetCameraLookAt = Module['_EffekseerSetCameraLookAt'] =
		...
		var _EffekseerReloadResources = (Module['_EffekseerReloadResources'] = function () {
			return (_EffekseerReloadResources = Module['_EffekseerReloadResources'] =
		...
		var _EffekseerGetDynamicInput = (Module['_EffekseerGetDynamicInput'] = function () {
			return (_EffekseerGetDynamicInput = Module['_EffekseerGetDynamicInput'] =
		...
		var _EffekseerSetDynamicInput = (Module['_EffekseerSetDynamicInput'] = function () {
			return (_EffekseerSetDynamicInput = Module['_EffekseerSetDynamicInput'] =
		...
		var _EffekseerSetTargetLocation = (Module['_EffekseerSetTargetLocation'] = function () {
			return (_EffekseerSetTargetLocation = Module['_EffekseerSetTargetLocation'] =
		...
		var _EffekseerGetRestInstancesCount = (Module['_EffekseerGetRestInstancesCount'] = function () {
			return (_EffekseerGetRestInstancesCount = Module['_EffekseerGetRestInstancesCount'] =
		...
		var _EffekseerSetRestorationOfStatesFlag = (Module['_EffekseerSetRestorationOfStatesFlag'] =
			function () {
				return (_EffekseerSetRestorationOfStatesFlag = Module[
					...
					Module['asm']['EffekseerSetRestorationOfStatesFlag']).apply(null, arguments)
			})
		var _EffekseerCaptureBackground = (Module['_EffekseerCaptureBackground'] = function () {
			return (_EffekseerCaptureBackground = Module['_EffekseerCaptureBackground'] =
		...
		var _EffekseerResetBackground = (Module['_EffekseerResetBackground'] = function () {
			return (_EffekseerResetBackground = Module['_EffekseerResetBackground'] =
		...
		var dynCall_vijf = (Module['dynCall_vijf'] = function () {
			return (dynCall_vijf = Module['dynCall_vijf'] = Module['asm']['dynCall_vijf']).apply(
				null,
				arguments
			)
		})
		...
		var dynCall_fiif = (Module['dynCall_fiif'] = function () {
			return (dynCall_fiif = Module['dynCall_fiif'] = Module['asm']['dynCall_fiif']).apply(
				null,
				arguments
			)
		})
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = effekseer_native
else if (typeof define === 'function' && define['amd'])
	define([], function () {
		return effekseer_native
	})
else if (typeof exports === 'object') exports['effekseer_native'] = effekseer_native
;('use strict')
var _typeof =
...
var effekseer = (function () {
	...
	var _onRuntimeInitialized = function _onRuntimeInitialized() {
		Core = {
			...
			SetProjectionMatrix: Module.cwrap('EffekseerSetProjectionMatrix', 'void', [
				'number',
				'number'
			]),
			SetProjectionPerspective: Module.cwrap('EffekseerSetProjectionPerspective', 'void', [
				'number',
				'number',
				'number',
				'number',
			...
			SetProjectionOrthographic: Module.cwrap('EffekseerSetProjectionOrthographic', 'void', [
				'number',
				'number',
				'number',
				'number',
			...
			SetRestorationOfStatesFlag: Module.cwrap('EffekseerSetRestorationOfStatesFlag', 'void', [
				'number',
				'number'
			]),
		...
		_createClass(EffekseerContext, [
			...
			},
			{
				...
				value: function setCameraLookAtFromVector(position, target, upvec) {
					upvecVector =
						(typeof upvecVector === 'undefined' ? 'undefined' : _typeof(upvecVector)) === 'object'
							? upvecVector
							: { x: 0, y: 1, z: 0 }
					Core.SetCameraLookAt(
						this.nativeptr,
