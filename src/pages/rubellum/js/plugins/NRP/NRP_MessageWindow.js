...
;(function () {
	...
	if (pMaskImage != null) {
		 ...
		 */
		if (
			Window_Message.prototype.showBackgroundDimmer == Window_Base.prototype.showBackgroundDimmer
		) {
		 ...
		 */
		if (
			Window_Message.prototype.hideBackgroundDimmer == Window_Base.prototype.hideBackgroundDimmer
		) {
