...
;(() => {
	...
	//
	Game_Interpreter.prototype.commandRoute = Game_Interpreter.prototype.toCommon = function (
		commonIdNote,
		flag
	) {
		if (!checkFlag(flag)) {
	...
	Game_Interpreter.prototype.commandRoute2 = Game_Interpreter.prototype.toCommon2 = function (
		eventIdNote,
		commonIdNote,
		flag
	) {
	...
	Game_Character.prototype.commandRoute = Game_Character.prototype.toCommon = function (
		notation,
		flag
	) {
		if (!checkFlag(flag)) {
