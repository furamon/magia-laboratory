...
;(function () {
	...
	Sprite_Character.prototype.setFrame = function (sx, sy, pw, ph) {
		if (this._character._offsets2) {
			...
			ph -= Math.min(
				Math.max(ph - sry - Math.max(-offsets2.y, 0), 0) + frameOffsets.y + Math.abs(offsets2.y),
				ph
			)
		}
	...
	Game_CharacterBase.prototype.makeCrossFadeSpriteRequested = function () {
		return this._IgDuration > 0 && this._IgFrames === this._IgDuration && !this._hasChildSprite
	}
