...
;(() => {
	...
	PluginManagerEx.registerCommand(script, 'MAKE', function (args) {
		...
		const x =
			xByVariableId != null && xByVariableId > 0 ? $gameVariables.value(xByVariableId) : args.x
		const y =
			yByVariableId != null && yByVariableId > 0 ? $gameVariables.value(yByVariableId) : args.y
