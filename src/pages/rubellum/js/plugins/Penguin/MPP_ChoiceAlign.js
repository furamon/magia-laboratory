...
;(() => {
	...
	PluginManager[_registerCommandName](pluginName, 'choiceAlign', (args) => {
	...
	Window_ChoiceList.prototype.drawItem = function (index) {
		const rect = this.itemRectForText ? this.itemRectForText(index) : this.itemLineRect(index)
		const text = this.commandName(index)
		const textWidth = this.textWidthEx ? this.textWidthEx(text) : this.textSizeEx(text).width
