...
;(() => {
	...
	const param_WindowParameters = JSON.parse(
		parameters['Name Window Parameters'] || '{}',
		reviverParse
	)
	...
	Game_MinimapMarker.prototype.isOverlap = function (x, y) {
		...
		if (this._type === 'C') {
			...
			return sx * $gameMap.minimap.xRate() <= 12 && sy * $gameMap.minimap.yRate() <= 12
		}
	}
	...
	Game_Minimap.prototype.clearCenter = function () {
		this.setCenter($gamePlayer._realX + 0.5, $gamePlayer._realY + 0.5)
	}
	...
	Game_Minimap.prototype.params = function () {
		return Game_Minimap.selecting ? param_DisplayPosition : _Game_Minimap_params.call(this)
	}
	...
	Game_Minimap.prototype.isLoopHorizontal = function () {
		return !Game_Minimap.selecting && _Game_Minimap_isLoopHorizontal.call(this)
	}

	const _Game_Minimap_isLoopVertical = Game_Minimap.prototype.isLoopVertical
	Game_Minimap.prototype.isLoopVertical = function () {
		return !Game_Minimap.selecting && _Game_Minimap_isLoopVertical.call(this)
	}
	...
	Game_Minimap.prototype.centerX = function () {
		return Game_Minimap.selecting ? this._centerX : _Game_Minimap_centerX.call(this)
	}

	const _Game_Minimap_centerY = Game_Minimap.prototype.centerY
	Game_Minimap.prototype.centerY = function () {
		return Game_Minimap.selecting ? this._centerY : _Game_Minimap_centerY.call(this)
	}
	...
	Game_Map.prototype.allMinimapMarkers = function () {
		return [..._Game_Map_allMinimapMarkers.call(this), this._minimap.pinMarker()]
	}
	...
	Sprite_MinimapMarker.markerSize = function () {
		return Game_Minimap.selecting ? param_MarkerSize : _Sprite_MinimapMarker_markerSize.call(this)
	}
	...
	Sprite_ScrollableMiniMap.prototype.scrollBy = function (x, y) {
		...
		this.scrollTo(rect.x + rect.width / 2 + x, rect.y + rect.height / 2 + y)
	}
	...
	Sprite_ScrollableMiniMap.prototype.cursorPos = function () {
		return new Point(Math.round(this._cursorX), Math.round(this._cursorY))
	}
