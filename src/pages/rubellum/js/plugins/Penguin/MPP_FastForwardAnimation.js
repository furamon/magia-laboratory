...
;(() => {
	...
	Window_BattleLog.prototype.isFastForward = function () {
		return _Window_BattleLog_isFastForward.apply(this, arguments) || battleFastForward
	}
	...
	Scene_Battle.prototype.updateFastForward = function () {
		if (this._fastForwardButton) {
			if (this._fastForwardButton.visible && Input.isTriggered(param_ToggleButton)) {
				battleFastForward = !battleFastForward
			}
		} else {
	...
	Scene_Battle.prototype.updateFastForwardVisibility = function () {
		if (this._fastForwardButton) {
			this._fastForwardButton.visible =
				!this._helpWindow.visible && this._messageWindow.isClosed() && BattleManager._phase !== ''
		}
	}
})()
