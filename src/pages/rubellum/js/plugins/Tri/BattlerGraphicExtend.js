...
;(function () {
	...
	Game_BattlerBase.prototype.getAltitude = function () {
		return this.isFloatingBattler()
			? Math.floor(Math.sin(this._altitudeAnimeCount / 16) * 5) - this._altitude
			: 0
	}
	...
	Sprite_Battler.prototype.updateBlendColor = function () {
		...
		realBlendColor[3] =
			color[3] / 2 + Math.floor((color[3] * (Math.sin(this._frameCount / interval) + 1)) / 4)
	...
	Sprite_Actor.prototype.motionSpeed = function () {
		return (
			_Sprite_Actor_motionSpeed.apply(this, arguments) /
			(this._battler ? this._battler.getMotionRate() : 1)
		)
	}
