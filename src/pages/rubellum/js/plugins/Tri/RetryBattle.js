...
;(() => {
	...
	BattleManager.checkBattleType = function () {
		return (
			(param.RetryNormalEnemy && !this._bossBattle) || (param.RetryBossEnemy && this._bossBattle)
		)
	}
	...
	Window_MenuCommand.prototype.isGameEndEnabled = function () {
		return (
			_Window_MenuCommand_isGameEndEnabled.apply(this, arguments) && !SceneManager.isSceneRetry()
		)
	}
