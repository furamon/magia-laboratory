...
;(() => {
	...
	Window_NameInput.JAPAN_KANJI_INDEX = [
		4, 5, 6, 7, 8, 65, 66, 3, 69, 72, 9, 12, 15, 16, 18, 3, 75, 79, 82, 86, 20, 22, 27, 28, 30, 3,
		90, 94, 98, 102, 32, 34, 35, 36, 37, 105, 106, 107, 109, 110, 39, 40, 41, 42, 43, 111, 112, 113,
		114, 115, 44, 46, 47, 48, 49, 3, 3, 3, 3, 3, 51, 52, 53, 54, 55, 3, 3, 3, 3, 3, 56, 57, 58, 64,
		3, 3, 3, 3, 3, 3, 59, 60, 61, 62, 63, 3, 3, 3, 3, 3
	]
	...
	Window_NameInput.CHINESE_TRADITIONAL_INDEX = [
		4, 7, 10, 13, 3, 87, 88, 89, 90, 92, 15, 19, 22, 24, 3, 94, 97, 101, 106, 111, 29, 32, 34, 3, 3,
		117, 123, 129, 134, 139, 37, 42, 45, 3, 3, 144, 148, 151, 153, 155, 49, 53, 56, 59, 3, 157, 158,
		159, 160, 161, 60, 62, 64, 3, 3, 162, 163, 164, 165, 166, 66, 67, 68, 69, 3, 3, 167, 3, 3, 3,
		70, 71, 72, 73, 3, 3, 3, 3, 3, 3, 74, 75, 76, 77, 78, 79, 83, 85, 3, 3
	]
	...
	Window_NameInput.prototype.table = function () {
		if ($gameSystem.isChinese()) {
			...
			return [Window_NameInput.KOREAN1, Window_NameInput.KOREAN2, Window_NameInput.KOREAN3]
	...
	Window_NameInput.prototype.cursorPageup = function () {
		if ($gameSystem.isChinese() && this._page == 0) {
			...
			$gameSystem.isChinese() &&
			this._page >= CharacterBoardPages &&
			this.table()[this._page - 1][88] == '返回'
		) {
			this._page = CharacterBoardPages
		} else if (
			$gameSystem.isJapanese() &&
			this._page >= CharacterBoardPages &&
			this.table()[this._page - 1][88] == '戻る'
		) {
			this._page = CharacterBoardPages
		}
	...
	Window_NameInput.prototype.processBack = function () {
		if (
			returnWithCancelButton &&
			($gameSystem.isChinese() || $gameSystem.isJapanese()) &&
			this._page >= CharacterBoardPages
		) {
	...
	const composeKorean = function (kor1, kor2) {
		if (koreanChoseong[kor1] !== undefined && koreanVowel[kor2] !== undefined) {
			...
			kor1.codePointAt(0) >= 0xac00 &&
			kor1.codePointAt(0) <= 0xd7a3 &&
			(kor1.codePointAt(0) - 0xac00) % 0x1c == 0 &&
			koreanJongseong[kor2] !== undefined
		) {
