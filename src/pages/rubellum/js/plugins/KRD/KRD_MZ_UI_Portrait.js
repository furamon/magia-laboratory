...
;(() => {
	...
	Scene_Base.prototype.buttonAreaHeight = function () {
		return BUTTON_AREA_HEIGHT
			? BUTTON_AREA_HEIGHT
			: KRD_Scene_Base_buttonAreaHeight.apply(this, arguments)
	}
	...
	const KRD_Window_MenuStatus_drawActorCharacterInFace =
		Window_MenuStatus.prototype.drawActorCharacterInFace
	...
	const KRD_Window_SkillStatus_drawActorCharacterInFace =
		Window_SkillStatus.prototype.drawActorCharacterInFace
	...
	Window_Base.prototype.drawCharacter2 = function (characterName, characterIndex, x, y) {
	...
	Window_MenuStatus.prototype.drawActorFace = function (actor, x, y, width, height) {
		const left =
			Graphics.boxWidth > BASIC_UI_WIDTH
				? Math.floor((this.width - x - MENU_STATUS_X - ImageManager.faceWidth) / 4)
				: 0
	...
	const KRD_Window_MenuStatus_drawActorSimpleStatus =
		Window_MenuStatus.prototype.drawActorSimpleStatus
	Window_MenuStatus.prototype.drawActorSimpleStatus = function (actor, x, y) {
		const left =
			Graphics.boxWidth > BASIC_UI_WIDTH ? Math.floor((this.width - x - MENU_STATUS_X) / 4) : 0
		const newX = x + MENU_STATUS_X + left
	...
	Window_MenuStatus.prototype.numVisibleRows = function () {
		return (
			$gameParty.maxBattleMembers() || KRD_Window_MenuStatus_numVisibleRows.apply(this, arguments)
		)
	}
	...
	const KRD_Window_BattleLog_showEnemyAttackAnimation =
