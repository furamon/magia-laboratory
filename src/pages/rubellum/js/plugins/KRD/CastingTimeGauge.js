...
;(function () {
	...
	//--------------------------------------------------------------------------
	/** ColorManager */
	ColorManager.castGaugeColor1 = function () {
		return this.textColor(14)
	}
	ColorManager.castGaugeColor2 = function () {
	...
	;(function () {
		...
		Sprite_Gauge.prototype.currentMaxValue = function () {
			return this.isCastingTimeGauge()
				? this._battler.tpbRequiredCastTime()
