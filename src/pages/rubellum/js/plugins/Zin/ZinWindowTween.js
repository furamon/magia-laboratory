...
;(() => {
	...
	ZinWindowTween.OpenTween = function (window, tweenParam) {
		if (window.refresh && tweenParam.enable) {
			...
			window
				.ztAlphaFrom(tweenParam.alpha, tweenParam.duration)
				.setEase(easing)
				.setDelay(tweenParam.delay)
			window
				.ztMoveByFrom(tweenParam.moveX, tweenParam.moveY, tweenParam.duration)
				.setEase(easing)
				.setDelay(tweenParam.delay)
		}
	}
	...
	ZinWindowTween.CloseTween = function (window, tweenParam, delay) {
		if (window.refresh && tweenParam.enable) {
			...
			window
				.ztMoveBy(tweenParam.moveX, tweenParam.moveY, tweenParam.duration)
				.setEase(easing)
				.setDelay(delay)
		}
	}
	...
	Scene_Menu.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(
			this,
			[this._statusWindow, this._commandWindow, this._goldWindow],
	...
	Scene_Item.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(
			this,
			[this._helpWindow, this._itemWindow, this._categoryWindow],
	...
	Scene_Skill.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(
			this,
			[this._helpWindow, this._itemWindow, this._statusWindow, this._skillTypeWindow],
			[
				param.windowHelpTween,
				param.windowSkillListTween,
				param.windowSkillStatusTween,
	...
	Scene_Equip.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(
			this,
			[this._helpWindow, this._slotWindow, this._statusWindow, this._commandWindow],
			[
				param.windowHelpTween,
				param.windowEquipSlotTween,
				param.windowEquipStatusTween,
	...
	Scene_Status.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(
			this,
			[this._statusEquipWindow, this._statusParamsWindow, this._statusWindow, this._profileWindow],
			[
				param.windowStatusEquipTween,
				param.windowStatusParamTween,
				param.windowStatusTween,
	...
	Scene_Options.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(this, [this._optionsWindow], [param.windowOptionTween], 'Option')
	}
	...
	Scene_File.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(
			this,
			[this._listWindow, this._helpWindow],
	...
	Scene_GameEnd.prototype.create = function () {
		...
		ZinWindowTween.OpenTweens(this, [this._commandWindow], [param.windowGameEndTween], 'GameEnd')
	}
	...
	Window_TitleCommand.prototype.ztCloseTween = function () {
		ZinWindowTween.CloseTween(
			this,
			param.windowTitleCommandTween,
			param.windowTitleCommandTween.delay
		)
	}
