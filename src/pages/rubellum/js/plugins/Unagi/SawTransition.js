...
;(() => {
	...
	PluginManager.registerCommand(
		SawTransitionPluginName,
		'StartTransitionEffectIn',
		function (args) {
	...
	Scene_Map.prototype.start = function () {
		...
		if (
			$gameTemp.getMapTransferTransitionSignal() &&
			$gameTemp.getMapChangeEffectSignal() === 'effectIn'
		) {
