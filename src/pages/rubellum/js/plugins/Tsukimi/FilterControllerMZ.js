...
;(function () {
	...
	Filter_Controller.prototype.createFilter = function () {
		...
		if (typeof filterClass === 'function') {
			if (filterClass === PIXI.filters.DisplacementFilter) filter = this.createDisplacement()
	...
	// defenition of each TargetType's target
	{
		...
		targetGetter[Type.Tile] = function (targetIds) {
			const targets = []
			if (this._spriteset && this._spriteset._tilemap && this._spriteset._tilemap._lowerLayer) {
	...
	const _getCharSpriteById = function (charSprites, id, length) {
		...
		if (id < 0) {
			...
			if (maybeTarget && maybeTarget._character && maybeTarget._character.eventId() === id) {
				return maybeTarget
			} else {
				let target = charSprites.find(
					(sprite_char) => sprite_char._character && sprite_char._character._eventId === id
				)
	...
	ConfigManager.applyData = function (config) {
		...
		} else this.TKMFilterEnabledAll = this.readFlag(config, 'TKMFilterEnabledAll')
	}
})()
			...
			return (
				(t.prototype.apply = function (e, t, n, r) {
					...
					if (1 === this._quality || 0 === this._blur)
						...
						for (
							var s, a = e.getFilterTexture(), u = t, c = a, f = this._quality - 1, h = 0;
							h < f;
							h++
						)
		...
		he = (function (e) {
			function t(t) {
				e.call(this, ue, fe.replace('${perlin}', ce)),
					...
					(t = Object.assign(
						{ angle: 30, gain: 0.5, lacunarity: 2.5, time: 0, parallel: !0, center: [0, 0] },
						t
					)),
			...
			function t(t, n, r) {
				void 0 === t && (t = [0, 0]),
					...
					Array.isArray(n) &&
						...
						(n = {})),
					(n = Object.assign(
						{ amplitude: 30, wavelength: 160, brightness: 1, speed: 500, radius: -1 },
						n
					)),
